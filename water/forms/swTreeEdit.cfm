...
<script language="JavaScript" src="../js/swTreeEdit.js"></script>
                                                                ...
                                                                <table cellpadding="0" cellspacing="0" border="0" style="width:100%;">
                                                                          ...
                                                                          <tr ng-repeat="RemoveTree in RemoveTreeList">
                                                                                       ...
                                                                                       <td class="frm left middle" style="width:20px;">
                                                                                        ...
                                                                                        <td class="frm left middle" style="width:33px;height:26px;padding:0px;">
                                                                    ...
                                                                    <table cellpadding="0" cellspacing="0" border="0" style="width:100%;">
                                                                       ...
                                                                       <tr ng-repeat="OnSiteReplaceTree in OnSiteReplaceTreeList">
                                                                            ...
                                                                            --->
                                                                                ...
                                                                                <td class="frm left middle" style="width:33px;height:26px;">
                                                                                ...
                                                                                <td style="width:2px;"></td>
                                                                                        ...
                                                                                        <td style="width:2px;"></td>
                                                                                         ...
                                                                                         <!--- species --->
                                                                                         <td class="frm left middle " style="width:80px;height:20px;">
