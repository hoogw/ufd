...
<script language="JavaScript" src="../js/swTreeEdit_watering.js"></script>
...
<!---  must remove ng-app='tree-app', otherwise chart will not load, ng-app bootstraps the element with the app,However, since we’re already doing that in our controller code (angular.bootstrap(document.body, ['myApp']);) --->
                        ...
                        <td>
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                  ...
                                  <tr>
                                        ...
                                        <td align="center" class="pagetitle" style="color:white;">Update Tree Replacement and Watering Site</td>
                                                                                    ...
                                                                                    <div>
                                                                                        <table cellpadding="0" cellspacing="0" border="0" style="width:100%;">
                                                                                            ...
                                                                                            <tr>
																								...
																								--->
                                                                                                <td class="frm" colspan="11" style="height:50px;">
                                                                                                <textarea ng-model="site_note" id="tree_trn" class="rounded" style="position:relative;top:0px;left:2px;width:936px;height:50px;"></textarea>
                                                                                                </td>
                                                                                            </tr>
                                                                                             ...
                                                                                             <!---  google calendar --->
                                                                                             <tr>
                                                                                                <td class="frm" colspan="11" style="height:500px;">
