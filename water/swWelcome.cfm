            ...
            <td align="center" class="formtitle">
                     ...
                     <!---
            			<font color="#request.color#"> 
                        			<div style="color:white;">
                                          Welcome to the<br>Tree Replacement And Watering
                                    </div>
                        </font>
                     ...
                     ---> 
                                                   ...
                                                   <!---  ----------  quick navigation link  --------------  --->
                                                    ...
                                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                     <a href="search/swWateringSearch.cfm">
                                                       <font size ="2" color="white"> All Tree (#all_tree_total#) </font>
                                                     </a>
                                                     
                                                     &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                     <a href="search/swWateringSearch.cfm?dmt=7&dlt=10">
                                                      <font size ="2" color="white"> 7 - 10 days (<font size ="4" color="red">#Between_7_to_10_total#</font>)  </font> 
                                                     </a>
		...
		<tr>	
			<td colspan="4" style="padding:0px 0px 0px 0px;">
				<table cellpadding="0" cellspacing="0" border="0">
					<tr>
					<th class="left middle" style="height:#ht#px;width:250px;">
					Total Number of Trees Removed for SRP
					</th>
					<td style="width:2px;"></td>
		...
		<tr>	
			<td colspan="4" style="padding:0px 0px 0px 0px;">
				<table cellpadding="0" cellspacing="0" border="0">
					<tr>
					<th class="left middle" style="height:#ht#px;width:250px;">
					Total Number of Trees Planted for SRP
					</th>
					<td style="width:2px;"></td>
		...
		<tr>	
			<td colspan="4" style="padding:0px 0px 0px 0px;">
				<table cellpadding="0" cellspacing="0" border="0">
					<tr>
					<th class="left middle" style="height:#ht#px;width:250px;">
					Total Number of Trees to be Removed for SRP
					</th>
					<td style="width:2px;"></td>
		...
		<tr>	
			<td colspan="4" style="padding:0px 0px 0px 0px;">
				<table cellpadding="0" cellspacing="0" border="0">
					<tr>
					<th class="left middle" style="height:#ht#px;width:250px;">
					Total Number of Trees to be Planted for SRP
					</th>
					<td style="width:2px;"></td>
