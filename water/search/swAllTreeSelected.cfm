   ...
   <head>
    ...
    <meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1">
       ...
       <link data-require="bootstrap-css@*" data-semver="3.3.6" rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.6/css/bootstrap.css" />
            ...
            <!--- our js --->
            <script language="JavaScript" src="../js/swAllTreeSelected.js"></script>
                                      ...
                                      <tr>
                                        <td>
                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                              ...
                                              <tr><td align="center" class="pagetitle"  style="position:relative;top:10px;color:white;">


                                              			Water Selected Trees
...
--->
                                    ...
                                    <table align=center border="0" cellpadding="0" cellspacing="0" style="width:100%;">
                                        ...
                                        <tr>
                                            ...
                                            <td >
                                                ...
                                                ng-click="save_all_current_water_date()">Save</a>
                                                
                                                
                                                                                                      <datepicker date-format="MM/dd/yyyy" date-typer="true" style="height:17px;width:380px;padding:3px 0px 0px 0px;">
                                                                                                              
                                                                                                              
                                                                                                              
                                                                                                                    <input ng-model="all_current_water_date" type="text" style="width:375px;"
                                                                                                                    
                                                                                                                      ng-change="date_changed()"
                                                                                                                      class="center roundedsmall"
                                                                                                                      
                                                                                                                      placeholder="Update All Selected Tree Current Watering Date"
             ...
             <!--- ------------------  End top filter box -------------------------  --->
            					...
            					<!---  -------------------   ng-grid   ------------------   --->
                                 ...
                                 <div  cellspacing="0" cellpadding="0" border="0" class="frame" align="center" style=" background-color: white;">   
                                               ...
                                               <!---  
                                                ...
                                                <div id="grid" ui-grid="gridOptions" style="height:800px" ui-grid-exporter ui-grid-selection ui-grid-edit >
                                                </div>
            					...
            					<!---  -------------------   End ng-grid   ------------------   --->                        
                                    ...
                                    <!---   ~~~~~~     End      ~~~ single click  tree ID  Modal ~~~~~~~~~~~~~~~~ --->
                                      ...
                                      <!---
                                       ...
                                       ---> 
                                        ...
                                        <div class="modal-body">
                                           ...
                                           <h6 class="modal-title">Please select some tree/row to water</h6>
...
<!---     --------------  query the previous water date by tree id -------------------     --->

			<cfset theData = Form.selected_rows_str>
            ...
            <cfelse> 
                <cfset cfData=DeserializeJSON(theData)> 
                 ...
                 <cfset _selected_rows_with_date =[]> 

                               <cfloop from="1" to="#arrayLen(cfData)#" index="i">
									  <cfset data = cfData[i]>   <!---  copy old data from previous page, selected rows --->
                                      
                                      <cfset data_live = []>     <!---  should get new live data from DB query --->
                                      ...
                                      <cfloop collection="#data#" item="key">
                                           ...
                                           <cfif key EQ 'ID'>
                                                ...
                                                <!---  This is old way of only calculate last water date
                                              
                                                <!---  <cfoutput>#key#:#data[key]#</cfoutput>   --->
                                                  ...
                                                  <cfquery name="select_last_watering_date" datasource="#request.sqlconn2#">
                                                                  ...
                                                                  FROM water
                                                                  where pk_id = #data[key]# 
                                                                                    
                                                                     
                                                   </cfquery>
                                                       
                                                    <!--- <cfoutput query="select_last_watering_date"> #Date#  </cfoutput>   --->
                                                  
                                                  <cfset _last_water_date = DateFormat(select_last_watering_date.Date[1], "mm/dd/yyyy")/>
                                                   <cfset todayDate = DateFormat(Now(), "mm/dd/yyyy")/>
                                                 
                                                 <cfset StructInsert(data, "Previous_Water_Date", _last_water_date ) />
                                               <!---  <cfset StructInsert(data, "Current_Water_Date", todayDate) />  --->
                                                  <cfset StructInsert(data, "Current_Water_Date", "") />
                                                  ...
                                                  <!---  ----------  new way is loop through ID, get live data  ----- --->
                                                  
                                                  <cfquery name="get_this_tree_by_id" datasource="#request.sqlconn2#">
                                                   ...
                                                   <cfset data_live = queryGetRow(get_this_tree_by_id, 1) > 
                                                    <cfset StructInsert(data_live, "Current_Water_Date", "") />
                                                    
                                                    <!---  End -------  new way is loop through ID, get live data  --->
                                      ...
                                      <!--- cfset ArrayAppend(_selected_rows_with_date, data) / --->
                                      <cfset ArrayAppend(_selected_rows_with_date, data_live) />
                                      
                                </cfloop>

                           <!---
                           <cfoutput>  #serializeJSON(_selected_rows_with_date)# </cfoutput>
                            --->

            </cfif>

<!---     --------  End  ------  query the previous water date by tree id -------------------     --->
...
<script>
		...
		//var _selected_rows = JSON.parse(_selected_rows_str);   ----- should not parse, since  xxx = [{},{}]; is already good to use.
		
		//var _selected_rows  = #Form.selected_rows_str#;  // ---- without previous water date
		
		  var _selected_rows  = #serializeJSON(_selected_rows_with_date)#;  // ---- water date added. 
		
		
		var _selected_rows_count  = #Form.selected_rows_count#;
