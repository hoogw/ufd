...
<cfif session.user_level lt 2 AND session.user_power is not 1>
	...
	<html>
			<head>
					<title>Tree Watering Program - Generate Tree Watering Reports</title>
							...
							<meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1">
								...
								<script src="//code.jquery.com/ui/1.11.4/jquery-ui.js"></script>
                                 ...
                                 <!--- angular --->
                                    ...
                                    <script language="JavaScript" src="../js/checklist-model/checklist-model.js"></script>
             ...
             <!--- our js --->
            <script language="JavaScript" src="../js/swReports.js"></script>
          <link rel="stylesheet" href="../css/ngshow.css">
...
<body ng-app="app" alink="#request.color#" vlink="#request.color#" bottommargin="0" marginheight="0" topmargin="2" rightmargin="0" style="overflow:auto;">

  <div ng-controller="ReportCtrl" data-ng-init="init()">
          ...
          <tr>
            <td>
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr><td align="center" class="pagetitle" style="color:white">Generate Tree Watering Reports</td></tr>
                  <tr><td height="15"></td></tr>
                </table>
            </td>
          </tr>
                                    ...
                                    <tr>
                                        <th class="drk left middle" colspan="4" style="height:30px;padding:0px 0px 0px 0px;">
                                                <table cellpadding="0" cellspacing="0" border="0">
                                                    <tr>
                                                    <th class="drk center middle" style="width:294px;">Select Water Report</th>
                                                    </tr>
                                                </table>
                                        </th>
                                    </tr>
                                                ...
                                                <table cellpadding="0" cellspacing="0" border="0" align="center">
                                                    ...
                                                    <tr>
                                                        <td>
                                                           ...
                                                           <a  id="watering_report_supervisor" href="../reports/Watering_Excel.cfm?type=supervisor&report_date=#dateFormat(Now(),"mm/dd/yyyy")#" 
                                                           target="_blank" style="color:#request.color#;">
														   
                                                           <!---
                                                           <a ng-click="get_supervisor_report()"  href="" id="watering_report_supervisor"  target="_blank" style="color:#request.color#;">
                                                           --->
                                                           
                                                           
                                                           Supervisor's SRP Tree Watering Report Excel File
                                                            </a>
                                                          </td>
                                                    </tr>
                                                     ...
                                                     <tr>
                                                        <td >
                                                             ...
                                                             <!---   
                                                                  ...
                                                                  <label>
                                                                         <input type="checkbox" ng-model="checked" aria-label="Toggle ngShow"> Show User 
                                                                  </label>
                                                                   &nbsp;&nbsp;&nbsp;&nbsp;
                                                              --->    
                                                                ...
                                                                <input type="Text" name="report_date_supervisor" id="report_date_supervisor" value="#dateFormat(Now(),"mm/dd/yyyy")#" style="width:67px;height:20px;padding:0px;text-align:center;" class="roundedsmall">
                                                 ...
                                                 <!---  ---------- hidden user details by default ------------- https://github.com/vitalets/checklist-model --->
                                                               ...
                                                               <tr>
                                                                    <td align="left">
                                                                              ...
                                                                              <div class="check-element animate-show-hide" ng-show="checked"> 
                                                                               ...
                                                                               <label>
                                                                                      <input type="checkbox" ng-model="checkboxModel.value1"  ng-change="check_uncheck_clicked()"> {{check_uncheck_lable}}
                                                                               </label>
                                                    ...
                                                    <!---  -------- End --------- -- hidden user details by default -------------  --->
                                   ...
                                   <tr>	
                                        <td colspan="4" style="padding:0px 0px 0px 0px;">
                                            <table cellpadding="0" cellspacing="0" border="0">
                                                ...
                                                <table cellpadding="0" cellspacing="0" border="0" align="center">
                                                    ...
                                                    <tr>
                                                        <td align="left">
                                                           ...
                                                           <a id="watering_report_current_user" href="../reports/Watering_Excel_Current_User.cfm?type=current_user&report_date=#dateFormat(Now(),"mm/dd/yyyy")#" 
                                                           target="_blank" style="color:#request.color#;">
                                                           
                                                           
                                                           
                                                         <!---  
                                                            <a ng-click="get_current_user_report()"  href="" id="watering_report_current_user"  target="_blank" style="color:#request.color#;">
                                                          
                                                           
                                                           
                                                            <a  id="watering_report_current_user" ng-href="../reports/Watering_Excel.cfm?report_date=#dateFormat(Now(),"mm/dd/yyyy")#"   target="_blank" style="color:#request.color#;">
															 --->
                                                           
                                                           #who_s# SRP Tree Watering Report Excel File
                                                            </a>
                                                          </td>
                                                    </tr>
                                                ...
                                                <input type="Text" name="report_date_current_user" id="report_date_current_user" value="#dateFormat(Now(),"mm/dd/yyyy")#" style="width:67px;height:20px;padding:0px;text-align:center;" class="roundedsmall">
...
$("#report_date_current_user").datepicker({
    onSelect: function() { 
       // var dateObject = $(this).datepicker('getDate'); 
		var dateObject = $(this).datepicker({ dateFormat: 'mm/dd/yyyy' }).val();
		console.log(dateObject);
		var _url = '../reports/Watering_Excel_Current_User.cfm?type=current_user&report_date=' +dateObject;
		
		console.log(_url);
		
		$("#watering_report_current_user").attr("href",_url );
    }
});


$("#report_date_supervisor").datepicker({
    onSelect: function() { 
       // var dateObject = $(this).datepicker('getDate'); 
		var dateObject = $(this).datepicker({ dateFormat: 'mm/dd/yyyy' }).val();
		console.log(dateObject);
		var _url = '../reports/Watering_Excel.cfm?type=supervisor&report_date=' +dateObject;
		
		console.log(_url);
		
		$("#watering_report_supervisor").attr("href",_url );
    }
});
