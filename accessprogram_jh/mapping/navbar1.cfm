...
<cfif  #request.action# is "print_app" or #request.action# is "process_app_form" or #request.action# is "attachments"  or #request.action# is "record_history" or #request.action# is "process_app_action" or #request.action# is "sidewalks1" or #request.action# is "trees1" or #request.action# is "spd_estimate_action" or #request.action# is "trees2" 
or #request.action# is "ufd_estimate_action"
>
...
(1) Sidewalks
<cfelse>
<a href="control.cfm?action=sidewalks1&arKey=#request.arKey#&#request.addtoken#">(1) Sidewalks</a>
</cfif>
...
(2) Trees
<cfelse>
<a href="control.cfm?action=trees1&arKey=#request.arKey#&#request.addtoken#">(2) Trees</a>
</cfif>
...
<cfelse>
<a href="control.cfm?action=process_app_form&arKey=#request.arKey#&#request.addtoken#">(3) Process Application</a>
</cfif>
