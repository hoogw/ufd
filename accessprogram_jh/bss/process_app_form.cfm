...
<form action="control.cfm?action=process_app_action&#request.addtoken#" method="post" name="form1" id="form1">
<input type="hidden" name="arKey" id="arKey" value="#request.arKey#">

<div class="formbox" style="width:350px;font-size:90%;">
...
<div class="field">
<cfif #findAR.sw_step1_comp# is "Y" and #findAR.swbb_step2_comp# is "Y" and #findAR.tree_step3_comp# is "Y" and #findAR.treebb_step4_comp# is "Y">
...
<div align="center">
		<div align="left" style="font-size:9.5pt;word-wrap:normal;font-style:italic;color:red;width:auto;height:auto;padding:5px;border:0px solid red;box-sizing:border-box;">
		*No Design Required <br> 
		*No changes are allowed after submittal<br>For further information contact Sidewalk Repair Division
	</div>
</div>
<cfelse>
	<label style="color:grey;"><input type="radio" name="ar_status_cd" disabled> Assessment Completed</label>
<div align="center">
	<div align="left" style="font-size:9.5pt;word-wrap:normal;font-style:italic;color:red;width:auto;height:auto;padding:5px;border:0px solid red;box-sizing:border-box;">
		*Steps 1-4 must be completed before using this option<br>
		*No Design Required <br> 
		*No changes are allowed after submittal<br> For further information contact Sidewalk Repair Division
	</div>
</div>
...
<div class="field">
<label><input type="radio" name="ar_status_cd" id="ar_status_cd" value="pendingBoeReview" <cfif #findAR.ar_status_cd# is "pendingBoeReview">checked</cfif>> Engineering Evaluation Required</label>

<label><input type="radio" name="ar_status_cd" id="ar_status_cd" value="pendingBssReview" <cfif #findAR.ar_status_cd# is "pendingBssReview">checked</cfif>> Keep for Further Investigation</label>
</div>

<div class="field">
<label for="bss_internal_comments">Internal Comments</label>
<textarea name="bss_internal_comments" id="bss_internal_comments" style="width:95%;height:100px;margin-top:5px;"></textarea>
(Internal Comments are shared among City staff)
</div>

</div>

<!--- <cfif #request.status_cd# is "pendingBSSReview"> --->
<cfif #findAR.ar_status_cd# is "BSSAssessmentCompleted">
	<!--- Do Nothing --->
<cfelse>
