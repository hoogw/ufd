...
if (document.form1.treebb_step4_comp[0].checked == false && document.form1.treebb_step4_comp[1].checked == false)
{
alert ("Please Select Yes or No!");
document.form1.treebb_step4_comp[0].focus();
return false;
}
// Validate Radio Buttons 
...
<cfquery name="treebb" datasource="#request.dsn#" dbtype="datasource">
select treebb_step4_comp, ar_status_cd
from ar_info
where arkey='#request.arkey#'
</cfquery>
...
<cfoutput>
<form action="control.cfm?action=ufd_bb_estimate_action&#request.addtoken#" method="post" name="form1" id="form1" onSubmit="return checkForm();">
<input type="hidden" name="arKey" id="arKey" value="#request.arKey#">

<div align="center">
<div class="formbox" style="width:350px;">
<h1>Tree Block to Block Information</h1>
...
<tr>
<td colspan="4">
		Is Tree Block to Block Assessment Completed? <br>
		<p>
		<cfif #treebb.treebb_step4_comp# is "">
			<input type="Radio" name="treebb_step4_comp" value="Y" id="treebb_step4_comp" style="width:65px;"<!---  required="true" --->> Yes
		 	<input type="Radio" name="treebb_step4_comp" value="N" id="treebb_step4_comp" style="width:65px;" <!--- required="true" --->> No	
			
		<cfelseif #treebb.treebb_step4_comp# is "y">
			<input type="Radio" name="treebb_step4_comp" value="Y" id="treebb_step4_comp" style="width:65px;" checked > Yes
	 		<input type="Radio" name="treebb_step4_comp" value="N" id="treebb_step4_comp" style="width:65px;" <!--- required="true" --->> No	

		<cfelseif #treebb.treebb_step4_comp# is "N">
			<input type="Radio" name="treebb_step4_comp" value="Y" id="treebb_step4_comp" style="width:65px;"  > Yes
	 		<input type="Radio" name="treebb_step4_comp" value="N" id="treebb_step4_comp" style="width:65px;" checked> No	

			
			
<!--- 	<cfelse>
		Tree Block to Block Assessment Status: 	<cfif #treebb.treebb_step4_comp# is "y"> 
													Completed
...
<cfif #treebb.ar_status_cd# is "BSSAssessmentCompleted">
<!----do nothing---->
<cfelse>
