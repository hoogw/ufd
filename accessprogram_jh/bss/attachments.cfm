...
<td>
<cfset request.file_name=ReplaceNoCase("#filename#"," ","_","ALL")>

<cfif #right(file_name,4)# is  ".pdf">
<a href="/docs/accessprogram/uploads/#request.ar_id#/#request.file_name#" target="_blank">#file_name#</a>
<cfelse>
<a href="../common/display_attachment.cfm?file_name=#request.file_name#&arKey=#request.arKey#&#request.addtoken#" target="_blank">#file_name#</a>
</cfif>
</td>
...
<!--- <cfoutput>
<div align="center">
<input type="button" name="uppload" id="upload" value="Add Attachments" class="submit" onClick="location.href = 'uploadfile1.cfm?ar_id=#request.ar_id#&#request.addtoken#'">
</div>
</cfoutput> --->
...
<br>
<div align="center"><a href="../public/uploadfile1.cfm?ar_id=#request.ar_id#&permit_type=#request.permit_type#&#request.addtoken#">Add Attachment</a></div>
</cfoutput>--->
<!---</CFIF>--->