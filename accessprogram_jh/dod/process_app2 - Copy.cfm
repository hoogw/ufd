...
<cfset request.srNum = #request.sr_number#>
<cfset request.srCode = "13"> <!--- Code 13 Not Eligible --->
<!--- <cfset request.srComment = "#request.reason_message# <br><br>If you would like to read more about the Access Request Program Requirements, you may view the Frequently Asked Questions here: 
<br> --->
<cfset request.srComment = "#request.reason_message#

<br><br>If you would like to read more about the Access Request Program Requirements, you may view the Frequently Asked Questions here: 
<br>
http://sidewalks.lacity.org
<br><br>
You may Report a Sidewalk Problem 
...
<cfset request.srNum = #request.sr_number#>
<cfset request.srCode = "13">
<cfset request.srComment = 	"Your Access Request is outside of the scope of the Access Request Program because the program only includes Pedestrian Facilities that were existing as of July 1, 2017.												
...
<!---<cfmail to="jimmy.lam@lacity.org" from="jimmy.lam@lacity.org" subject="Message from Access Program">
#now()#
#request.srComment#</cfmail>--->

<cfmail to="jimmy.lam@lacity.org" from="jimmy.lam@lacity.org" subject="Message from Access Program - Test" cc="essam.amarragy@lacity.org,jimmy.lam@lacity.org" type="html">
#now()#
<br>
#request.srNum#
<br>
