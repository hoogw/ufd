...
<cfset request.apiKey = "8lN5QbdIeZGNu1P7orjIIemsDwrA7WAR"> <!--- apiKey to access myLA311 --->
<cfset request.url_sfx = "_qa"> <!--- the testing myla311 url is slightly different from production so need this to adjust the url --->

<!--- switch to t on test/development server --->
<cfif #request.production# is 0>
<cfset request.serverRoot = "http://localhost">
<cfset request.myLA311Root = "https://lacity-test.apigee.net">
...
<cfset request.myLA311Root = "https://lacity-prod.apigee.net">
<cfset request.url_sfx = ""> 
</cfif>
