...
where
	...
	and ar_status_desc='#request.status#'
...
<cfif not isdefined("request.status")>
<span class="warning">Status is Required!</span>
<cfabort>
</cfif>
...
<cfoutput>
<div class="subtitle">#unprocessed_investigations.recordcount# Applications #request.status#<br>
