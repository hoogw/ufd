...
, ar_info.SR_ACCESS_COMMENTS
 ...
 ,dateDiff("d",dbo.ar_info.dod_to_bss_dt, getdate())as daysInQueue1
...
where
	...
	and isdate(ar_info.BSS_Assessed_dt)=0 
	and ar_info.ar_status_cd = 'pendingbssreview'
...
<cfoutput>
<div class="subtitle">#unprocessed_investigations.recordcount# Applications Pending BSS Review<br>
