...
<form action="control.cfm?action=Rpt_Count_Summary2&#request.addtoken#" method="post" name="form1" id="form1" onSubmit="return checkForm();">


<div class="title">Summary Report of Sidewalk Submittals</div>
