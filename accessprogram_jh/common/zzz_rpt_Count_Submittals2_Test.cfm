...
where			   
<!---   ar_info.ar_status_cd = 'received' 
	and  --->
	
	ar_status.ar_status_desc <> 'assessment completed'
</cfquery>
...
<cfoutput>
<div style="margin-right:auto;margin-left:auto;width:90%;"><div style="width:100%;text-align:right;">Records #start_row# To #END_ROW# out of #unprocessed_investigations.recordcount# Records Testing</div></div>
</cfoutput>
</cfif>
