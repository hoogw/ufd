...
<cfoutput>
<cfif #request.action# is "downloadreceived1">

<form action="control.cfm?action=downloadreceived2&#request.addtoken#" method="post" name="form1" id="form1" onSubmit="return checkForm();">


<div class="title"><!--- Report Count of Unprocessed Sidewalk Submittals --->
				Download Received Access Requests by <br>Date Range and Council District
</div>
...
<div class="title"><!--- Report Count of Unprocessed Sidewalk Submittals --->
				Download All Access Requests by <br>Date Range and Council District
</div>
