...
<form action="control.cfm?action=Rpt_Count_Approved_DOD2&#request.addtoken#" method="post" name="form1" id="form1" onSubmit="return checkForm();">


<div class="title">Report Count of Sidewalk Submittals <br> Approved by DOD</div>
