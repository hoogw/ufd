...
<form action="control.cfm?action=Rpt_Search_Status2&#request.addtoken#" method="post" name="form1" id="form1" onSubmit="return checkForm();">


<div class="title">Report Count of Sidewalk Submittals <br> by Status</div>
...
<td><input type="text" name="ddate1" id="ddate1" size="15" maxlength="15"></td>
</tr>

<tr>
<td>End Date (Requried)</td>
<td><input type="text" name="ddate2" id="ddate2" size="15" maxlength="15"></td>
</tr>

<tr>
<td>Application Status (Required)</td>

<cfquery name="status" datasource="#request.dsn#" dbtype="datasource">
select distinct(ar_status.ar_status_desc) as status
