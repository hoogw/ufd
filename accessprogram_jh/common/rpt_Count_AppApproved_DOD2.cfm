...
, ar_info.SR_ACCESS_COMMENTS
 ...
 , 	case 
		when isDate(dbo.ar_info.dod_to_bss_dt)=1  then dateDiff("d", dbo.ar_info.ddate_submitted, dbo.ar_info.dod_to_bss_dt)
		else  dateDiff("d", dbo.ar_info.ddate_submitted, getDate()) 
	End as daysInQueue  
...
<cfoutput>
<div class="subtitle">#unprocessed_investigations.recordcount# Applications Approved by DOD<br>
...
<!--- <cfif #unprocessed_investigations.dod_denied_by# <> null>
