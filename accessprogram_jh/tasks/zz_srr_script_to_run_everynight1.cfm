<div align="center">Document Disabled!</div>
<cfabort>
...
WHERE 
srr_status_cd = 'waitListed'
order by ddate_submitted
</cfquery>

<!--- <cfdump var="#waitListed#" output="browser"> --->

<CFLOOP query="waitListed">
<cfinclude template="../common/calc_balanceNow.cfm">
<cfif #waitListed.prop_type# is "R" and #request.balanceNow# gte 2000>
...
, offer_paid_amt = 0
, record_history = record_history + '|Application moved from waiting list to the received list on (#dateformat(Now(),"mm/dd/yyyy")# at #timeformat(now(),"h:mm tt")#).'
...
<cfelseif #waitListed.prop_type# is "C" and #request.balanceNow# gte 4000>
<cfquery name="updateStatus" datasource="#request.dsn#" dbtype="datasource">
update srr_info
set
srr_status_cd = 'received'
, waitListed_to_received_dt = #now()#
, offer_reserved_amt = 4000
, offer_open_amt = 0
, offer_accepted_amt = 0
, offer_paid_amt = 0
, record_history = record_history + '|Application moved from waiting list to the received list on (#dateformat(Now(),"mm/dd/yyyy")# at #timeformat(now(),"h:mm tt")#).'
...
, offer_accepted_amt = 0
, offer_paid_amt = 0
, record_history = record_history + '|14 days have passed since application was found to be NOT Eligible. Appeal deadline was on  #dateformat(notEligibleTemp.notEligible_exp_dt,"mm/dd/yyyy")#.'
...
<cfloop query="incompleteDocsTemp">
<cfquery name="updateStatus" datasource="#request.dsn#" dbtype="datasource">
update srr_info
set
...
, offer_accepted_amt = 0
, offer_paid_amt = 0
, record_history = record_history + '|Application canceled on #dateformat(Now(),"mm/dd/yyyy")# at #timeformat(now(),"h:mm tt")#.  14 days have passed since BPW requested addtional documents on #dateformat(incompleteDocsTemp.incompleteDocs_dt,"mm/dd/yyyy")# to verify eligibility.  Applicant did not provide the requested documents.'
...
, offer_accepted_amt = 0
, offer_paid_amt = 0
, record_history = record_history + '|Application Canceled on #dateformat(Now(),"mm/dd/yyyy")# at #timeformat(now(),"h:mm tt")#.  14 days have passed since BCA indicated that the site is already ADA compliant.'
...
, offer_accepted_amt = 0
, offer_paid_amt = 0
, record_history = record_history + '|Application status has been updated to Offer Expired on(#dateformat(Now(),"mm/dd/yyyy")# at #timeformat(now(),"h:mm tt")#).  Applicant did not accept or decline the offer within 14 days.'
...
<!--- <cfdump var="#offerMade#" output="browser"> --->
...
, offer_accepted_amt = 0
, offer_paid_amt = 0
, record_history = record_history + '|Application status has been permanently  updated to Offer Declined on(#dateformat(Now(),"mm/dd/yyyy")# at #timeformat(now(),"h:mm tt")#).  Applicant cannot accept the offer anymore (14 days have passed since applicant declined the offer.'
where srr_id = #notEligibleTemp.srr_id#
</cfquery>
...
where 
ApermitSubmitted_dt is null
and 
a_ref_no is not null
</cfquery>
...
and
ddate_submitted is not null
</cfquery>
<cfif #checkSubmitted.recordcount# is 1 and isdate(#checkSubmitted.ddate_submitted#)>
...
and
boe_ddate_processed is not null
and 
application_status = 'issued'
</cfquery>
<cfif #checkIssued.recordcount# is 1 and isdate(#checkIssued.boe_ddate_processed#)>
<cfquery name="updateSrr" datasource="#request.dsn#" dbtype="datasource">
update srr_info
set 
...
<!--- <cfdump var="#getApermitSubmitted_dt#" output="browser"> --->


<!--- offerAccepted , applicant has to submit all required permits within 60 days or offer will be expired --->
...
<cfif #checkOfferAccepted.nbr_trees_removed# gt 0>
<cfset request.TrPermitRequired = 1>
<cfelse>
<cfset request.TrPermitRequired = 0>
</cfif>

<cfif isdate(#checkOfferAccepted.TrPermitSubmitted_dt#)>
<cfset request.TrPermitSubmitted = 1>
<cfset request.TrPermitSubmitted_dt = #checkOfferAccepted.TrPermitSubmitted_dt#>
<cfelse>
...
<cfif #checkOfferAccepted.nbr_trees_pruned# gt 0>
<cfset request.TpPermitRequired = 1>
<cfelse>
<cfset request.TpPermitRequired = 0>
</cfif>

<cfif isdate(#checkOfferAccepted.TpPermitSubmitted_dt#)>
<cfset request.TpPermitSubmitted = 1>
<cfset request.TpPermitSubmitted_dt = #checkOfferAccepted.TpPermitSubmitted_dt#>
<cfelse>
...
<cfset request.newStatus = #checkOfferAccepted.srr_status_cd#>

<!--- or dateCompare(#checkOfferAccepted.offerAccepted_exp_dt#, #now()#) is 0 and (dateCompare(#checkOfferAccepted.offerAccepted_exp_dt#, #now()#) is -1)--->
...
<cfset request.requiredPermitsSubmitted_dt = #checkOfferAccepted.ApermitSubmitted_dt#>
...
<cfset request.requiredPermitsSubmitted_dt = #checkOfferAccepted.TrPermitSubmitted_dt#>
</cfif>
...
<cfset request.requiredPermitsSubmitted_dt = #checkOfferAccepted.TpPermitSubmitted_dt#>
</cfif>
...
, record_history = record_history + '|All required permits were submitted as of #dateformat(Now(),"mm/dd/yyyy")# at #timeformat(now(),"h:mm tt")#.'
...
, requiredPermitsNotSubmitted_exp_dt = dateAdd("d", 14, #now()#)
, record_history = record_history + '|All required permits were NOT submitted as of #dateformat(Now(),"mm/dd/yyyy")# at #timeformat(now(),"h:mm tt")#.  Request Expired for not meeting the deadlines.'
where srr_id = #checkOfferAccepted.srr_id#
</cfquery>
...
<cfset request.newStatus = #checkRequiredPermitsIssued.srr_status_cd#><!--- = requiredPermitsSubmitted --->
...
<!--- Check Tree Removal Permit --->
<cfif #checkRequiredPermitsIssued.nbr_trees_removed# gt 0><!--- 1 --->
<cfset request.TrPermitRequired = 1>
<cfif isdate(#checkRequiredPermitsIssued.TrPermitIssued_dt#)>
<cfset request.TrPermitIssued = 1>
<cfset request.TrPermitIssued_dt = #checkRequiredPermitsIssued.TrPermitIssued_dt#>
<cfelse>
...
<!--- Check Tree Pruning Permit --->
<cfif #checkRequiredPermitsIssued.nbr_trees_pruned# gt 0><!--- 1 --->
<cfset request.TpPermitRequired = 1>
<cfif isdate(#checkRequiredPermitsIssued.TpPermitIssued_dt#)>
<cfset request.TpPermitIssued = 1>
<cfset request.TpPermitIssued_dt = #checkRequiredPermitsIssued.TpPermitIssued_dt#>
<cfelse>
...
<!--- or dateCompare(#checkOfferAccepted.offerAccepted_exp_dt#, #now()#) is 0--->
...
<cfelseif #request.TrPermitRequired# is 1  and  #request.trPermitIssued# is 0>
<cfset request.newStatus = "requiredPermitsSubmitted">
<cfset request.requiredPermitsIssued_dt = "">

<cfelseif #request.TpPermitRequired# is 1  and  #request.TpPermitIssued# is 0>
<cfset request.newStatus = "requiredPermitsSubmitted">
<cfset request.requiredPermitsIssued_dt = "">

<cfelseif #request.TrPermitRequired# is 1  and  #request.trPermitIssued# is 1 and #request.TpPermitRequired# is 0>
<cfset request.newStatus = "requiredPermitsIssued">
...
<cfset request.requiredPermitsIssued_dt = #checkRequiredPermitsIssued.TrPermitIssued_dt#>
</cfif>

<cfelseif #request.TrPermitRequired# is 1  and  #request.trPermitIssued# is 1 and #request.TpPermitRequired# is 1 and #request.TpPermitIssued# is 0>
<cfset request.newStatus = "requiredPermitsSubmitted">
<cfset request.requiredPermitsIssued_dt = "">

<cfelseif #request.TrPermitRequired# is 1  and  #request.trPermitIssued# is 1 and #request.TpPermitRequired# is 1 and #request.TpPermitIssued# is 1>
<cfset request.newStatus = "requiredPermitsIssued">
<cfset request.requiredPermitsIssued_dt = #checkRequiredPermitsIssued.ApermitSubmitted_dt#>
<cfif dateCompare(#request.requiredPermitsIssued_dt#, #request.TrPermitIssued_dt#) is -1>
<cfset request.requiredPermitsIssued_dt = #checkRequiredPermitsIssued.TrPermitIssued_dt#>
...
<cfset request.requiredPermitsIssued_dt = #checkRequiredPermitsIssued.TpPermitIssued_dt#>
</cfif>
...
, record_history = record_history + '|All required permits were Issued as of #dateformat(request.requiredPermitsIssued_dt,"mm/dd/yyyy")#.'
...
, record_history = record_history + '|All required permits were Issued as of #dateformat(checkConstCompleted.requiredPermitsIssued_dt,"mm/dd/yyyy")#.  90 days have passed since all required permits were issued.  This application is deemed expired as of #dateformat(checkConstCompleted.requiredPermitsIssued_exp_dt,"mm/dd/yyyy")#'
where 
...
<cfmail to="essam.amarragy@lacity.org" from="SRRTasks@lacity.org" subject="Srr Nightly Script Successfully Completed">
