...
<cfdirectory action="CREATE" directory="#getAR.upload_dir#">
</cfif> --->
...
arKey = '#request.arKey#'
 ...
 --->
<!--- <cfquery name="getaAR" datasource="#request.dsn#" dbtype="datasource">
select * from ar_info
where 
arKey = '#request.arKey#'
</cfquery> --->

<!--- <cfif #getAR.recordcount# is 0>
<cfmodule template="/accessprogram/common/error_msg.cfm" error_msg="Could not Find Your Sidewalk Rebate Request!<br><br>Please Contact the Sidewalk Repair Program.">
<cfabort>
</cfif>
 --->
