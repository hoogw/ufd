...
<cfset strTable = "tblTreeList">
<cfset seTable = "tblEngineeringEstimate">

<!--- <CFOUTPUT>sir number is:  #attributes.sr_no# <br></CFOUTPUT> --->

<cfquery name="getLocationNumber" datasource="#sDS#" result="r">
select Location_No from tblSites where sr_number = '#attributes.sr_no#'
</cfquery>
...
from #seTable# where Location_No = #_location_no#
</cfquery>
...
select count(*) as count from #strTable#
...
SELECT * FROM #seTable# WHERE location_no = #_location_no#  
</cfquery>
	...
	<cfloop from="1" to= #totalStump# index="i">
		...
		<cfquery name="insert_tblTreeList" datasource="#sDS#" result="r">
			<cfif _hasHDRcertificate_issue_date >
				INSERT INTO #strTable# (Location_No, GROUP_NO, TREE_NO,      TREE_REMOVAL_DATE,                                 TYPE,      ACTION_TYPE,Creation_Date,        DELETED)
				VALUES (#_location_no#, 1,    #_addTreeNo# , #CreateODBCDateTime(_IssueDate_HDRcertificate)# , #_tree_type#, 0,       #CreateODBCDateTime(Now())#, 0);
			<cfelse>          
				INSERT INTO #strTable# (Location_No, GROUP_NO, TREE_NO,      ACTION_TYPE, Creation_Date,           DELETED)
	...
	<cfloop from="1" to= #totalTreePlant# index="i">
		...
		<cfquery name="insert_tblTreeList" datasource="#sDS#" result="r">
			<cfif (_hasHDRcertificate_issue_date) >
				...
				<cfelse>
					INSERT INTO #strTable# (Location_No, GROUP_NO, TREE_NO, TREE_PLANTING_DATE, TYPE, ACTION_TYPE, Creation_Date,  DELETED)
...
<cfelse>
	...
	<cfloop from="1" to= #__TREE_ROOT_PRUNING_L_SHAVING__PER_TREE___QUANTITY# index="i">
		...
		<cfquery name="insert_tblTreeList" datasource="#sDS#" result="r">
			<cfif _hasHDRcertificate_issue_date >
				INSERT INTO #strTable# (Location_No, GROUP_NO, TREE_NO,      ROOT_PRUNING_DATE,                                 TYPE,      ACTION_TYPE,Creation_Date,        DELETED)
