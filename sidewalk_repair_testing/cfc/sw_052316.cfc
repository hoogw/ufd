<cfcomponent output="false">
	...
	<cffunction name="downloadSiteSearch" access="remote" returnType="any" returnFormat="plain" output="false">
		...
		<cftry>
			...
			<cfset columns = "Site,Council District,Package,Facility Name,Address,Construction Start Date,Construction Completed Date,Priority No,Total Cost,Total Concrete,Type,Work Order">
			...
			construction_completed_date,priority_no,total_cost,total_concrete,type_desc,work_order FROM session.siteQuery
			</cfquery>
	...
	<cffunction name="downloadCurbSearch" access="remote" returnType="any" returnFormat="plain" output="false">
		...
		<cftry>
			...
			<cfset columns = "Curb Ramp No,Council District,Site No,Intersection Corner,Primary Street,Secondary Street,Construction Completed Date,Priority No,Type">
			
			<cfquery name="setSearch" dbtype="query">
			SELECT ramp_no,council_district as cd, location_no as site,intersection_corner,primary_street,secondary_street,construction_completed_date,
			priority_no,type_description FROM session.curbQuery
			</cfquery>
