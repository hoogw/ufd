<cfcomponent output="false">
	...
	<cffunction name="downloadCurbSearch" access="remote" returnType="any" returnFormat="plain" output="false">
		...
		<cftry>
			...
			<cfset columns = "Curb Ramp No,Council District,Site No,Intersection Corner,Primary Street,Secondary Street,Construction Completed Date,Designed By,Priority No,Type">
