			...
			<tr>	
				<td colspan="4" style="padding:0px 0px 0px 0px;">
					<table cellpadding="0" cellspacing="0" border="0">
						...
						<select name="ss_pgroup" id="ss_pgroup" class="rounded" style="width:75px;">
						<option value=""></option>
						<cfset cnt = 1>
			...
			<tr>	
				<td colspan="4" style="padding:0px 0px 0px 0px;">
					<table cellpadding="0" cellspacing="0" border="0">
						...
						<input type="Text" name="ss_name" id="ss_name" value="" style="width:183px;" class="rounded"></td>
						<td style="width:2px;"></td>
						<th class="left middle" style="height:30px;width:52px;">Address:</th>
						<td style="width:2px;"></td>
						...
						<td style="width:2px;"></td>
						<td class="frm" style="width:50px;">
						<input type="Text" name="ss_pn" id="ss_pn" value="" style="width:45px;" class="rounded"></td>
					</table>
				</td>
			</tr>
			...
			<tr>	
				<td colspan="4" style="padding:0px 0px 0px 0px;">
					<table cellpadding="0" cellspacing="0" border="0">
						...
						<td style="width:2px;"></td>
						<td class="frm"  style="width:80px;">
						<select name="ss_repairs" id="ss_repairs" class="rounded" style="width:75px;">
						<option value=""></option>
						<cfloop query="getYesNo">
							<option value="#id#">#value#</option>
						</cfloop>
			...
			<tr>	
				<td colspan="4" style="padding:0px 0px 0px 0px;">
					<table cellpadding="0" cellspacing="0" border="0">
						...
						<td style="width:2px;"></td>
						<td class="frm" style="width:248px;"><!--- <input type="Text" name="ss_assdt" id="ss_assdt" value="" style="width:75px;" class="rounded">
						<span class="page">&nbsp;<strong>OR</strong>&nbsp;</span> --->
						<span class="page">&nbsp;&nbsp;From:&nbsp;</span>
						<input type="Text" name="ss_assfrm" id="ss_assfrm" value="" style="width:85px;" class="rounded">
						<span class="page">&nbsp;&nbsp;To:&nbsp;</span>
						<input type="Text" name="ss_assto" id="ss_assto" value="" style="width:85px;" class="rounded">
						</td>
						<td style="width:2px;"></td>
