		...
		<tr>
			...
			<tr>	
				<td colspan="4" style="padding:0px 0px 0px 0px;">
					<table cellpadding="0" cellspacing="0" border="0">
						...
						<td style="width:2px;"></td>						
						<th class="left middle" style="width:40px;">Type:</th>
						<td style="width:2px;"></td>
			...
			<tr>	
				<td colspan="4" style="padding:0px 0px 0px 0px;">
					<table cellpadding="0" cellspacing="0" border="0">
						...
						<input type="Text" name="scr_primary" id="scr_primary" value="" style="width:251px;height:20px;padding:0px 0px 0px 4px;" class="roundedsmall"></td>
						<td style="width:2px;"></td>
						<th class="left middle" style="width:97px;">Secondary Street:</th>
						<td style="width:2px;"></td>
						...
						<td style="width:2px;"></td>
						<th class="left middle" style="width:55px;">Zip Code:</th>
						<td style="width:2px;"></td>
			...
			<tr>	
				<td colspan="4" style="padding:0px 0px 0px 0px;">
					<table cellpadding="0" cellspacing="0" border="0">
						...
						<td style="width:2px;"></td>
						<th class="left middle" style="width:117px;">Design Required:</th>
						<td style="width:2px;"></td>
						<td class="frm"  style="width:86px;">
						<select name="scr_design" id="scr_design" class="roundedsmall" style="width:81px;height:20px;padding:0px 0px 0px 4px;">
						<option value=""></option>
						<cfloop query="getYesNo">
							<option value="#id#">#value#</option>
						</cfloop>
						...
						<select name="scr_applicable" id="scr_applicable" class="roundedsmall" style="width:80px;height:20px;padding:0px 0px 0px 4px;">
						<option value=""></option>
						<cfloop query="getYesNo">
							<option value="#id#">#value#</option>
						</cfloop>
			...
			<tr>	
				<td colspan="4" style="padding:0px 0px 0px 0px;">
					<table cellpadding="0" cellspacing="0" border="0">
						<tr>
						<th class="left middle" style="height:22px;width:147px;">Design Start Date:</th>
						<td style="width:2px;"></td>
						<td class="frm" style="width:272px;"><!--- <input type="Text" name="ss_assdt" id="ss_assdt" value="" style="width:75px;" class="rounded">
						<span class="page">&nbsp;<strong>OR</strong>&nbsp;</span> --->
						<span class="page">&nbsp;&nbsp;From:&nbsp;</span>
						<input type="Text" name="scr_dsdfrm" id="scr_dsdfrm" value="" style="width:97px;height:20px;padding:0px 0px 0px 4px;" class="roundedsmall">
						<span class="page">&nbsp;&nbsp;To:&nbsp;</span>
						<input type="Text" name="scr_dsdto" id="scr_dsdto" value="" style="width:97px;height:20px;padding:0px 0px 0px 4px;" class="roundedsmall">
						</td>
						<td style="width:2px;"></td>
						<th class="left middle" style="width:154px;">Design Finish Date:</th>
						<td style="width:2px;"></td>
						<td class="frm" style="width:242px;">
						<span class="page">&nbsp;&nbsp;From:&nbsp;</span>
						<input type="Text" name="scr_dfdfrm" id="scr_dfdfrm" value="" style="width:82px;height:20px;padding:0px 0px 0px 4px;" class="roundedsmall">
						<span class="page">&nbsp;&nbsp;To:&nbsp;</span>
						<input type="Text" name="scr_dfdto" id="scr_dfdto" value="" style="width:82px;height:20px;padding:0px 0px 0px 4px;" class="roundedsmall">
						</td>
						</tr>
					</table>
				</td>
			...
			<tr>	
				<td colspan="4" style="padding:0px 0px 0px 0px;">
					<table cellpadding="0" cellspacing="0" border="0">
						<tr>
						<th class="left middle" style="height:22px;width:147px;">Assessed Date:</th>
						<td style="width:2px;"></td>
						<td class="frm" style="width:272px;"><!--- <input type="Text" name="ss_assdt" id="ss_assdt" value="" style="width:75px;" class="rounded">
						<span class="page">&nbsp;<strong>OR</strong>&nbsp;</span> --->
						<span class="page">&nbsp;&nbsp;From:&nbsp;</span>
						<input type="Text" name="scr_assfrm" id="scr_assfrm" value="" style="width:97px;height:20px;padding:0px 0px 0px 4px;" class="roundedsmall">
						<span class="page">&nbsp;&nbsp;To:&nbsp;</span>
						<input type="Text" name="scr_assto" id="scr_assto" value="" style="width:97px;height:20px;padding:0px 0px 0px 4px;" class="roundedsmall">
						</td>
						<td style="width:2px;"></td>
						...
						<td class="frm" style="width:242px;">
						<span class="page">&nbsp;&nbsp;From:&nbsp;</span>
						<input type="Text" name="scr_ccdfrm" id="scr_ccdfrm" value="" style="width:82px;height:20px;padding:0px 0px 0px 4px;" class="roundedsmall">
						<span class="page">&nbsp;&nbsp;To:&nbsp;</span>
						<input type="Text" name="scr_ccdto" id="scr_ccdto" value="" style="width:82px;height:20px;padding:0px 0px 0px 4px;" class="roundedsmall">
						</td>
						</tr>
					</table>
				</td>
...
<table border="0" cellpadding="0" cellspacing="0" style="height:25px;width:100%;border:0px red solid;">
	<tr><td cellspacing="0" cellpadding="0" border="0" bgcolor="white" bordercolor="white">
		...
		<tr>
			...
			<th class="drk center middle" style="width:350px;" onclick="sortTable(5);return false;" onmouseover="this.style.cursor='pointer';">Secondary Street</th>
			<th class="drk center middle" style="width:105px;" onclick="sortTable(6);return false;" onmouseover="this.style.cursor='pointer';">Con. Completed</th>
...
function submitForm() {
	...
	$.ajax({
	  ...
	  success: function(data) { 
		...
		var sno; var rid; var pst; var sst; var sconc; var spry; var stype; var ic; var cd;
		...
		if (query.DATA.length > 0) {
			$.each(query.DATA, function(i, item) {
				...
				items.push("<td style='padding:2px 0px 0px 5px;width:346px;' class='small frm'>" + item[sst] + "</td>");
				//items.push("<td style='width:79px;' class='small center frm'>" + item[scons] + "</td>");
				items.push("<td style='width:104px;' class='small center frm'>" + item[sconc] + "</td>");
