...
<table cellspacing="0" cellpadding="0" border="0" class="frame" align="center" style="width:790px;">
		...
		<tr>
			...
			<tr>	
				<td colspan="4" style="padding:0px 0px 0px 0px;">
					<table cellpadding="0" cellspacing="0" border="0">
						<tr>
						<th class="left middle" style="height:30px;width:85px;">Location No:</th>
						...
						<td style="width:2px;"></td>
						<th class="left middle" style="width:82px;">Package No:</th>
						<td style="width:2px;"></td>
						<td class="frm" style="width:60px;">
						...
						<select name="ss_type" id="ss_type" class="rounded" style="width:215px;">
						<option value=""></option>
			...
			<tr>	
				<td colspan="4" style="padding:0px 0px 0px 0px;">
					<table cellpadding="0" cellspacing="0" border="0">
						<tr>
						<th class="left middle" style="width:85px;">Facility Name:</th>
						<td style="width:2px;"></td>
						...
						<td style="width:2px;"></td>
						<th class="left middle" style="height:30px;width:67px;">Work Order:</th>
						<td style="width:2px;"></td>
						<td class="frm" style="width:80px;">
						<input type="Text" name="ss_wo" id="ss_wo" value="" style="width:75px;" class="rounded"></td>
					</table>
				</td>
			</tr>
			...
			<tr>	
				<td colspan="4" style="padding:0px 0px 0px 0px;">
					<table cellpadding="0" cellspacing="0" border="0">
						...
						<td style="width:2px;"></td>
						<th class="left middle" style="width:82px;">Council District:</th>
						<td style="width:2px;"></td>
						<td class="frm" style="width:60px;">
						<select name="ss_cd" id="ss_cd" class="rounded" style="width:55px;">
						<option value=""></option>
						...
						<td style="width:2px;"></td>
						<td class="frm" style="width:80px;">
						<input type="Text" name="ss_zip" id="ss_zip" value="" style="width:75px;" class="rounded"></td>
						</tr>
					</table>
				</td>
			</tr>
