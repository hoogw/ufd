		...
		<tr>
			...
			<tr>	
				<td colspan="4" style="padding:0px 0px 0px 0px;">
					<table cellpadding="0" cellspacing="0" border="0">
						...
						<input type="Text" name="ss_pno" id="ss_pno" value="" style="width:55px;height:20px;padding:0px 0px 0px 4px;" class="roundedsmall"></td>
						<td style="width:2px;"></td>						
						<th class="left middle" style="width:38px;">Type:</th>
						<td style="width:2px;"></td>
						<td class="frm"  style="width:145px;">
						<select name="ss_type" id="ss_type" class="roundedsmall" style="width:140px;height:20px;padding:0px 0px 0px 4px;">
						<option value=""></option>
			...
			<tr>	
				<td colspan="4" style="padding:0px 0px 0px 0px;">
					<table cellpadding="0" cellspacing="0" border="0">
						...
						<td style="width:2px;"></td>
						<th class="left middle" style="width:154px;">QC Date:</th>
						<td style="width:2px;"></td>
			...
			<tr>	
				<td colspan="4" style="padding:0px 0px 0px 0px;">
					<table cellpadding="0" cellspacing="0" border="0">
						<tr>
						<th class="left middle" style="height:22px;width:147px;">Construction Started Date:</th>
						<td style="width:2px;"></td>
						<td class="frm" style="width:272px;"><!--- <input type="Text" name="ss_assdt" id="ss_assdt" value="" style="width:75px;" class="rounded">
						<span class="page">&nbsp;<strong>OR</strong>&nbsp;</span> --->
						<span class="page">&nbsp;&nbsp;From:&nbsp;</span>
...
<table border="0" cellpadding="0" cellspacing="0" style="height:25px;width:100%;border:0px red solid;">
	<tr><td cellspacing="0" cellpadding="0" border="0" bgcolor="white" bordercolor="white">
		...
		<tr>
			...
			<th class="drk center middle" style="width:80px;" onclick="sortTable(12);return false;" onmouseover="this.style.cursor='pointer';">Total Concrete</th>
...
function submitForm() {
	...
	$.ajax({
	  ...
	  success: function(data) { 
		...
		var sno; var ssfx; var sp; var sg; var sname; var saddr; var stype; var swo; var sid; var spid; var spry; var cd; var tc; var tcon;
		...
		if (query.DATA.length > 0) {
			$.each(query.DATA, function(i, item) {
				...
				items.push("<td style='width:79px;' class='small center frm'>" + item[tcon].toFixed(2).replace('.00','') + "</td>");
