...
<table cellspacing="0" cellpadding="0" border="0" class="frame" align="center" style="width:860px;">
			...
			<tr>	
				<td colspan="4" style="padding:0px 0px 0px 0px;">
					<table cellpadding="0" cellspacing="0" border="0">
						...
						<td style="width:2px;"></td>
						<th class="left middle" style="width:81px;">Council District:</th>
						<td style="width:2px;"></td>
						<td class="frm" style="width:51px;">
						<select name="ss_cd" id="ss_cd" class="rounded" style="width:46px;">
						<option value=""></option>
			...
			<tr>	
				<td colspan="4" style="padding:0px 0px 0px 0px;">
					<table cellpadding="0" cellspacing="0" border="0">
						...
						<td style="width:2px;"></td>
						<td class="frm" style="width:210px;">
						<input type="Text" name="ss_address" id="ss_address" value="" style="width:208px;" class="rounded"></td>
						<td style="width:2px;"></td>
						<th class="left middle" style="height:30px;width:73px;">Work Order:</th>
						<td style="width:2px;"></td>
						<td class="frm" style="width:87px;">
						<input type="Text" name="ss_wo" id="ss_wo" value="" style="width:82px;" class="rounded"></td>
						<td style="width:2px;"></td>
						<th class="left middle" style="height:30px;width:59px;">Priority No:</th>
						<td style="width:2px;"></td>
						<td class="frm" style="width:51px;">
						<input type="Text" name="ss_pn" id="ss_pn" value="" style="width:46px;" class="rounded"></td>
					</table>
				</td>
			</tr>
			...
			<tr>	
				<td colspan="4" style="padding:0px 0px 0px 0px;">
					<table cellpadding="0" cellspacing="0" border="0">
						...
						<select name="ss_repairs" id="ss_repairs" class="rounded" style="width:50px;">
						<option value=""></option>
						<cfloop query="getYesNo">
							<option value="#id#">#value#</option>
						</cfloop>
						...
						<td style="width:2px;"></td>
						<td class="frm"  style="width:60px;">
						<select name="ss_removed" id="ss_removed" class="rounded" style="width:55px;">
						<option value=""></option>
						<cfloop query="getYesNo">
							<cfif id is 1>
							<option value="#id#">#value#</option>
						...
						<td style="width:2px;"></td>
						<th class="left middle" style="height:30px;width:62px;">Curb<br>Ramp Only:</th>
						<td style="width:2px;"></td>
						<td class="frm"  style="width:55px;">
			...
			<tr>	
				<td colspan="4" style="padding:0px 0px 0px 0px;">
					<table cellpadding="0" cellspacing="0" border="0">
						...
						<td style="width:2px;"></td>
						<th class="left middle" style="height:30px;width:66px;">Keyword:</th>
						<td style="width:2px;"></td>
...
function submitForm() {
	...
	$.ajax({
	  ...
	  success: function(data) { 
		...
		var sno; var ssfx; var sp; var sg; var sname; var saddr; var stype; var swo; var sid; var spid; var spry;
