		...
		<tr>
			...
			<tr>	
				<td colspan="4" style="padding:0px 0px 0px 0px;">
					<table cellpadding="0" cellspacing="0" border="0">
						<tr>
						<th class="left middle" style="height:30px;width:81px;">Location No:</th>
						<td style="width:2px;"></td>
						<td class="frm" style="width:61px;">
						<input type="Text" name="ss_no" id="ss_no" value="" style="width:56px;" class="rounded"></td>
						<td style="width:2px;"></td>
						...
						<select name="ss_pgroup" id="ss_pgroup" class="rounded" style="width:72px;">
						<option value=""></option>
						<cfset cnt = 1>
						...
						<input type="Text" name="ss_pno" id="ss_pno" value="" style="width:55px;" class="rounded"></td>
						<td style="width:2px;"></td>						
						<th class="left middle" style="width:38px;">Type:</th>
						<td style="width:2px;"></td>
						...
						<select name="ss_cd" id="ss_cd" class="rounded" style="width:50px;">
						<option value=""></option>
			...
			<tr>	
				<td colspan="4" style="padding:0px 0px 0px 0px;">
					<table cellpadding="0" cellspacing="0" border="0">
						<tr>
						<th class="left middle" style="width:81px;">Facility Name:</th>
						<td style="width:2px;"></td>
						<td class="frm" style="width:189px;">
						<input type="Text" name="ss_name" id="ss_name" value="" style="width:184px;" class="rounded"></td>
						<td style="width:2px;"></td>
						<th class="left middle" style="height:30px;width:50px;">Address:</th>
						<td style="width:2px;"></td>
						<td class="frm" style="width:247px;">
						<input type="Text" name="ss_address" id="ss_address" value="" style="width:242px;" class="rounded"></td>
						
						
						<td style="width:2px;"></td>
						<th class="left middle" style="height:30px;width:50px;">Zip Code:</th>
						<td style="width:2px;"></td>
						<td class="frm" style="width:60px;">
						<input type="Text" name="ss_zip" id="ss_zip" value="" style="width:55px;" class="rounded"></td>
						
						<td style="width:2px;"></td>
						<th class="left middle" style="height:30px;width:58px;">Priority No:</th>
						<td style="width:2px;"></td>
						<td class="frm" style="width:55px;">
						<input type="Text" name="ss_pn" id="ss_pn" value="" style="width:50px;" class="rounded"></td>
					</table>
				</td>
			</tr>
			...
			<tr>	
				<td colspan="4" style="padding:0px 0px 0px 0px;">
					<table cellpadding="0" cellspacing="0" border="0">
						<tr>
						<th class="left middle" style="height:30px;width:81px;">Field Assessed:</th>
						<td style="width:2px;"></td>
						<td class="frm"  style="width:60px;">
						...
						<select name="ss_repairs" id="ss_repairs" class="rounded" style="width:73px;">
						<option value=""></option>
						<cfloop query="getYesNo">
							<option value="#id#">#value#</option>
						</cfloop>
						...
						<td style="width:2px;"></td>
						<td class="frm" style="width:60px;">
						<select name="ss_severity" id="ss_severity" class="rounded" style="width:55px;">
						<option value=""></option>
						...
						<td style="width:2px;"></td>
						<th class="left middle" style="height:30px;width:88px;">Site Deleted:</th>
						<td style="width:2px;"></td>
						<td class="frm"  style="width:67px;">
						<select name="ss_removed" id="ss_removed" class="rounded" style="width:62px;">
						<option value=""></option>
						<cfloop query="getYesNo">
							<cfif id is 1>
							<option value="#id#">#value#</option>
						...
						<td style="width:2px;"></td>
						<th class="left middle" style="height:30px;width:107px;">Curb Ramp Only:</th>
						<td style="width:2px;"></td>
						<td class="frm"  style="width:55px;">
						<select name="ss_curbramp" id="ss_curbramp" class="rounded" style="width:50px;">
						<option value=""></option>
						<cfloop query="getYesNo">
							<option value="#id#">#value#</option>
						</cfloop>
			...
			<tr>	
				<td colspan="4" style="padding:0px 0px 0px 0px;">
					<table cellpadding="0" cellspacing="0" border="0">
						<tr>
						<th class="left middle" style="width:81px;">Assessed Date:</th>
						<td style="width:2px;"></td>
						<td class="frm" style="width:246px;"><!--- <input type="Text" name="ss_assdt" id="ss_assdt" value="" style="width:75px;" class="rounded">
						<span class="page">&nbsp;<strong>OR</strong>&nbsp;</span> --->
						<span class="page">&nbsp;&nbsp;From:&nbsp;</span>
						<input type="Text" name="ss_assfrm" id="ss_assfrm" value="" style="width:84px;" class="rounded">
						<span class="page">&nbsp;&nbsp;To:&nbsp;</span>
						<input type="Text" name="ss_assto" id="ss_assto" value="" style="width:84px;" class="rounded">
						</td>
						<td style="width:2px;"></td>
						<th class="left middle" style="height:30px;width:85px;">QC Date:</th>
						<td style="width:2px;"></td>
						...
						<td style="width:2px;"></td>
						<th class="left middle" style="height:30px;width:68px;">Work Order:</th>
						<td style="width:2px;"></td>
						<td class="frm" style="width:94px;">
						<input type="Text" name="ss_wo" id="ss_wo" value="" style="width:89px;" class="rounded"></td>
					</table>
				</td>
			</tr>
			...
			<tr>	
				<td colspan="4" style="padding:0px 0px 0px 0px;">
					<table cellpadding="0" cellspacing="0" border="0">
						<tr>
						<th class="left middle" style="width:81px;">Construction Started Date:</th>
						<td style="width:2px;"></td>
						<td class="frm" style="width:246px;"><!--- <input type="Text" name="ss_assdt" id="ss_assdt" value="" style="width:75px;" class="rounded">
						<span class="page">&nbsp;<strong>OR</strong>&nbsp;</span> --->
						<span class="page">&nbsp;&nbsp;From:&nbsp;</span>
						<input type="Text" name="ss_consfrm" id="ss_consfrm" value="" style="width:84px;" class="rounded">
						<span class="page">&nbsp;&nbsp;To:&nbsp;</span>
						<input type="Text" name="ss_consto" id="ss_consto" value="" style="width:84px;" class="rounded">
						</td>
						<td style="width:2px;"></td>
						<th class="left middle" style="height:30px;width:85px;">Construction Completed Date:</th>
						<td style="width:2px;"></td>
						<td class="frm" style="width:228px;">
						<span class="page">&nbsp;&nbsp;From:&nbsp;</span>
						<input type="Text" name="ss_concfrm" id="ss_concfrm" value="" style="width:75px;" class="rounded">
						<span class="page">&nbsp;&nbsp;To:&nbsp;</span>
						<input type="Text" name="ss_concto" id="ss_concto" value="" style="width:75px;" class="rounded">
						</td>
						<td style="width:2px;"></td>
						<th class="left middle" style="height:30px;width:68px;">Keyword:</th>
						<td style="width:2px;"></td>
						<td class="frm" style="width:94px;">
						<input type="Text" name="ss_keyword" id="ss_keyword" value="" style="width:89px;" class="rounded"></td>
					</table>
				</td>
			</tr>
...
<table border="0" cellpadding="0" cellspacing="0" style="height:25px;width:100%;border:0px red solid;">
	<tr><td cellspacing="0" cellpadding="0" border="0" bgcolor="white" bordercolor="white">
		...
		<tr>
			...
			<th class="drk center middle" style="width:80px;" onclick="sortTable(8);return false;" onmouseover="this.style.cursor='pointer';">Type</th>
...
function sortTable(idx) {
	...
	case 7: sort.id = idx; sort.dir = dir; sort.order = "priority_no " + dir + ",location_no,location_suffix"; break;
	case 8: sort.id = idx; sort.dir = dir; sort.order = "type_desc " + dir + ",location_no,location_suffix"; break;
...
function submitForm() {
	...
	$.ajax({
	  ...
	  success: function(data) { 
		...
		var sno; var ssfx; var sp; var sg; var sname; var saddr; var stype; var swo; var sid; var spid; var spry; var cd;
