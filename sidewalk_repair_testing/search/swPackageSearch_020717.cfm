...
<table cellspacing="0" cellpadding="0" border="0" class="frame" align="center" style="width:660px;">
		...
		<tr>
			...
			<tr>	
				<td colspan="4" style="padding:0px 0px 0px 0px;">
					<table cellpadding="0" cellspacing="0" border="0">
						<tr>
						<th class="left middle" style="height:30px;width:100px;">Package Group:</th>
						...
						<td style="width:2px;"></td>
						<th class="left middle" style="width:100px;">Package Number:</th>
						<td style="width:2px;"></td>
						<td class="frm" style="width:80px;">
						<input type="Text" name="ps_no" id="ps_no" value="" style="width:75px;" class="rounded"></td>
						<td style="width:2px;"></td>
						<th class="left middle" style="width:115px;">Work Order Number:</th>
						<td style="width:2px;"></td>
						<td class="frm" style="width:157px;">
						<input type="Text" name="ps_wo" id="ps_wo" value="" style="width:152px;" class="rounded"></td>
						</tr>
					</table>
				</td>
			</tr>
			...
			<tr>	
				<td colspan="4" style="padding:0px 0px 0px 0px;">
					<table cellpadding="0" cellspacing="0" border="0">
						...
						<td style="width:2px;"></td>
						<td class="frm" style="width:202px;">
						<input type="Text" name="ps_con" id="ps_con" value="" style="width:197px;" class="rounded"></td>
						<td style="width:2px;"></td>
						<th class="left middle" style="width:80px;">Facility Name:</th>
						<td style="width:2px;"></td>
						<td class="frm" style="width:278px;">
						<input type="Text" name="ps_name" id="ps_name" value="" style="width:273px;" class="rounded"></td>
					</table>
				</td>
			</tr>
...
function changeHeight() {
	...
	$('#ps_results').width(w);
	$('#ps_header').width(w);
	if ( $("#ps_results").height() > $("#tbl_results").height()) { $("#ps_results").height($("#tbl_results").height()); }
}
...
function submitForm() {
	...
	$.ajax({
	  ...
	  success: function(data) { 
		...
		var pg; var pn; var pcon; var pwo; var pid;
