...
<iframe NAME="download_package" id="download_package" src="" allowtransparency="true" background-color="transparent" style="height:400px;width:800px;border:1px red solid;" frameborder="0"></iframe>
...
function downloadData() {
	...
	$('#download_package').prop('src',url + "reports/bid_package.cfm?pk=BOE-13");
