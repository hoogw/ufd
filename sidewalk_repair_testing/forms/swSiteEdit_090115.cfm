		...
		<tr>
			...
			<tr>
				...
				<td colspan="4" style="padding:0px 0px 0px 0px;">
					<table cellpadding="0" cellspacing="0" border="0">
						<tr>
						<th class="left middle" style="height:20px;width:527px;"><span style="position:relative;top:3px;">Tree Removal Description:</span></th>
						<td style="width:2px;"></td>
			...
			<tr>
				<cfset v = getSite.tree_removal_description>
				<td class="frm" colspan="4" style="height:42px;">
				<textarea id="sw_tree_desc" class="rounded" style="position:relative;top:0px;left:2px;width:679px;height:36px;" #dis#>#v#</textarea>
				</td>
			</tr>
	...
	<td cellspacing="0" cellpadding="0" border="0" bgcolor="white" bordercolor="white">
		...
		<tr>
			...
			<tr>
				...
				<cfset num = getFlds.recordcount+4>
...
function submitForm() {
	...
	frm.push({"name" : "sw_tree_desc", "value" : trim($('#sw_tree_desc').val()) });
	
	if ($('#sw_tree_rmv').is(':disabled')) {
		frm.push({"name" : "sw_tree_rmv", "value" : trim($('#sw_tree_rmv').val()) });
	}
