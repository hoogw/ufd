			...
			<tr>	
				<td colspan="4" style="padding:0px 0px 0px 0px;">
					<table cellpadding="0" cellspacing="0" border="0">
						...
						<th class="left middle" style="height:30px;width:164px;">Not to Exceed Amount:</th>
						<td style="width:2px;"></td>
						...
						<input type="Text" name="sw_ntea" id="sw_ntea" value="#trim(v)#" style="width:129px;" class="center rounded" #dis#>
						</td>
						<td style="width:2px;"></td>
						
						<th class="left middle" style="width:69px;">Site Walk:</th>
						<td style="width:2px;"></td>
						<cfset v = ""><cfif getPackage.site_walk_date is not ""><cfset v = dateformat(getPackage.site_walk_date,"MM/DD/YYYY")></cfif>
						<td class="frm" style="width:#w4+6#px;">
						<input type="Text" name="sw_swalk" id="sw_swalk" value="#v#" style="width:#w4+1#px;text-align:center;" class="rounded" #dis#></td>
						<td style="width:2px;"></td>
						
						<th class="left middle" style="width:145px;">10 Day Notice:</th>
						<td style="width:2px;"></td>
						<cfset v = ""><cfif getPackage.ten_day_notice_date is not ""><cfset v = dateformat(getPackage.ten_day_notice_date,"MM/DD/YYYY")></cfif>
						<td class="frm" style="width:115px;">
						<input type="Text" name="sw_tdn" id="sw_tdn" value="#v#" style="width:110px;text-align:center;" class="rounded" #dis#></td>
