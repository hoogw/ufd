		...
		<tr>
			...
			<tr>	
				<td colspan="4" style="padding:0px 0px 0px 0px;">
					<table cellpadding="0" cellspacing="0" border="0">
						<tr>
						<th class="left middle" style="width:185px;">Contractor's Price:</th>
						<td style="width:2px;"></td>
						<cfset v = 0.00>
						<cfif getContract.recordcount gt 0>
						...
						<input type="Text" name="sw_con_price" id="sw_con_price" value="#v#" style="width:130px;text-align:center;" class="rounded" disabled></td>
						<td style="width:2px;"></td>
