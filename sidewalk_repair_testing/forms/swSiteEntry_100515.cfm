		...
		<tr>
			<th class="drk left middle" colspan="4" style="height:30px;padding:0px 0px 0px 0px;">
					...
					<table cellpadding="0" cellspacing="0" border="0">
						...
						<th class="drk right middle" style="width:100px;">Location Number:</th>
						<td style="width:55px;">
			...
			<tr>
				...
				<td colspan="4" style="padding:0px 0px 0px 0px;">
					<table cellpadding="0" cellspacing="0" border="0">
						...
						<td style="width:2px;"></td>
						<td class="frm" style="width:60px;">
						<input type="Text" name="sw_zip" id="sw_zip" value="" style="width:55px;" class="rounded">
						</td>
						</tr>
					</table>
				</td>
			...
			<!--- <tr>	
				<td colspan="4" style="padding:0px 0px 0px 0px;">
					<table cellpadding="0" cellspacing="0" border="0">
						...
						<input type="Text" name="sw_qc" id="sw_qc" value="" style="width:103px;" class="rounded"></td> --->
						<td style="width:2px;"></td>
						<th class="left middle" style="width:100px;">QC Date:</th>
						<td style="width:2px;"></td>
						<td class="frm" style="width:145px;">
						<input type="Text" name="sw_qcdate" id="sw_qcdate" value="" style="width:140px;" class="rounded"></td>
						</tr>
					</table>
				</td>
			</tr> --->
