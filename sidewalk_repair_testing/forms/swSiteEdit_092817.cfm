...
<table cellspacing="0" cellpadding="0" border="0" class="frame" align="center" style="width:985px;">
	<form name="form7" id="form7" method="post" action="" enctype="multipart/form-data">
	<tr>
	<td cellspacing="0" cellpadding="0" border="0" bgcolor="white" bordercolor="white">
		<table align=center bgcolor=white cellspacing="2" cellpadding="2" border="0" style="width:985px;">
		<tr>
			<th class="drk left middle" colspan="2" style="height:30px;padding:0px 0px 0px 0px;">
				<table cellpadding="0" cellspacing="0" border="0">
					<tr>
					<th class="drk left middle" style="width:312px;">Tree Information</th>
					<td align="right" style="width:565px;">
		...
		<td colspan="2" style="padding:0px;">
			...
			<tr>
				...
				<table cellpadding="0" cellspacing="0" border="0" style="width:100%;">
					...
					<td style="width:2px;"></td>
					<th class="left middle" style="width:219px;">Species:</th>	
					<td style="width:2px;"></td>
				...
				<table cellpadding="0" cellspacing="0" border="0" style="width:100%;">
					...
					<td style="width:2px;"></td>
					<td class="frm left middle" style="width:220px;">
					<div class="ui-widget">
					...
					style="width:217px;height:20px;padding:0px 2px 0px 4px;" class="roundedsmall" #trdis#>
					</div>
					</td>	
					<td style="width:2px;"></td>
					<td class="frm left middle">
			...
			<tr>
				...
				<table cellpadding="0" cellspacing="0" border="0" style="width:100%;">
					...
					<td style="width:2px;"></td>
					<th class="left middle" style="width:168px;">Species:</th>		
					<td style="width:2px;"></td>
					<th class="left middle" style="width:36px;padding: 1px 1px 1px 3px;">Offsite:</th>	
					<td style="width:2px;"></td>
				...
				<table cellpadding="0" cellspacing="0" border="0" style="width:100%;">
					...
					<cfset v = ""><cfif trim(getList.permit_issuance_date) is not "">
					<cfset v = dateformat(trim(getList.permit_issuance_date),"mm/dd/yyyy")></cfif>
					<td class="frm left middle" style="width:74px;"><input type="Text" name="tppidt_#scnt#_#trcnt#" id="tppidt_#scnt#_#trcnt#" value="#v#" 
					...
					<td style="width:2px;"></td>
					<td class="frm left middle" style="width:169px;">
					<div class="ui-widget">
					<cfset v = ""><cfif trim(getList.species) is not ""><cfset v = trim(getList.species)></cfif>
  					<label for="tp_species_#scnt#_#trcnt#"></label>
					<input type="Text" name="tpspecies_#scnt#_#trcnt#" id="tpspecies_#scnt#_#trcnt#" value="#v#" 
					style="width:166px;height:20px;padding:0px 2px 0px 4px;" class="roundedsmall" #trdis#>
					</div>
					</td>	
					
					<td style="width:2px;"></td>
					<cfset v = ""><cfif getList.offsite is 1><cfset v = "checked"></cfif>
					<td class="frm left middle" style="width:36px;">
					<div style="position:relative;left:7px;"><input id="tpoffsite_#scnt#_#trcnt#" name="tpoffsite_#scnt#_#trcnt#" type="checkbox" #v#></div>
					</td>
		...
		<tr>
			...
			<table cellpadding="0" cellspacing="0" border="0" style="width:100%;">
					...
					<td colspan="11">
						<table cellpadding="0" cellspacing="0" border="0">
							<tr>
								...
								<td class="frm left middle" style="width:325px;"><input type="Text" name="tree_arbname" id="tree_arbname" value="#v#" 
								style="width:320px;" class="rounded"></td>
								<td style="width:2px;"></td>
								...
								<td class="frm left middle" style="width:116px;"><input type="Text" name="tree_preinspby" id="tree_preinspby" value="#v#" 
								style="width:111px;" class="rounded"></td>
								<td style="width:2px;"></td>
								<th class="left middle" style="height:30px;width:169px;">
									<table cellpadding="0" cellspacing="0" border="0">
									<tr>
					...
					<td colspan="11">
						<table cellpadding="0" cellspacing="0" border="0">
							<tr>
								...
								<td class="frm left middle" style="width:325px;"><input type="Text" name="tree_trc" id="tree_trc" value="#v#" 
								style="width:320px;" class="rounded"></td>
								<td></td>
								<td style="width:2px;"></td>
								...
								<td style="width:2px;"></td>
								<td class="frm left middle" style="width:116px;"><input type="Text" name="tree_preinspdt" id="tree_preinspdt" value="#v#" 
								style="width:111px;text-align:center;" class="rounded"></td>
								<td style="width:2px;"></td>
								<th class="left middle" style="height:30px;width:169px;"></th>
							</tr>
						</table>
					</td>
				</tr>
					...
					<td colspan="11">
						<table cellpadding="0" cellspacing="0" border="0">
							<tr>
								...
								<td class="frm left middle" style="width:325px;"><input type="Text" name="tree_tpc" id="tree_tpc" value="#v#" 
								style="width:320px;" class="rounded"></td>
								<td style="width:2px;"></td>
								...
								<td style="width:2px;"></td>
								<td class="frm left middle" style="width:116px;"><input type="Text" name="tree_postinspby" id="tree_postinspby" value="#v#" 
								style="width:111px;" class="rounded"></td>
								<td style="width:2px;"></td>
								<th class="left middle" style="height:30px;width:169px;"></th>
							</tr>
					...
					<td colspan="11">
						<table cellpadding="0" cellspacing="0" border="0">
							<tr>
								...
								<td class="frm left middle" style="width:325px;"><input type="Text" name="tree_twc" id="tree_twc" value="#v#" 
								style="width:320px;" class="rounded" disabled></td>
								<td></td>
								<td style="width:2px;"></td>
								...
								<td class="frm left middle" style="width:116px;"><input type="Text" name="tree_postinspdt" id="tree_postinspdt" value="#v#" 
								style="width:111px;text-align:center;" class="rounded"></td>
								<td style="width:2px;"></td>
								<th class="left middle" style="height:30px;width:169px;"></th>
							</tr>
				...
				<tr>
					...
					<textarea id="tree_trn" class="rounded" style="position:relative;top:0px;left:2px;width:971px;height:69px;">#v#</textarea>
					</td>
				</tr>
