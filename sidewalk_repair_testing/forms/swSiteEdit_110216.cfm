	...
	<td cellspacing="0" cellpadding="0" border="0" bgcolor="white" bordercolor="white">
		...
		<tr>
			...
			<tr>
				...
				<cfset distmp = dis>
				<cfif getSite.curb_ramp_only is 1><cfset dis = "disabled"></cfif>
				<textarea id="sw_tree_notes" name="sw_tree_notes" class="rounded" style="position:relative;top:0px;left:2px;width:679px;height:41px;" disabled <!--- #dis# --->>#v#</textarea>
				<cfset dis = distmp>
				</td>
			</tr>
			...
			<tr>
				...
				<!--- <cfset distmp = dis>
				<cfif getSite.curb_ramp_only is 1><cfset dis = "disabled"></cfif> --->
				<textarea id="sw_notes" name="sw_notes" class="rounded" style="position:relative;top:0px;left:2px;width:679px;height:41px;" #dis#>#v#</textarea>
				<!--- <cfset dis = distmp> --->
				</td>
			</tr>
			...
			<tr>
				...
				<td class="frm" colspan="4" style="height:42px;">
				<textarea id="sw_loc" name="sw_loc" class="rounded" style="position:relative;top:0px;left:2px;width:679px;height:41px;" #dis#>#v#</textarea>
				</td>
			</tr>
			...
			<tr>
				...
				<td class="frm" colspan="4" style="height:42px;">
				<textarea id="sw_damage" name="sw_damage" class="rounded" style="position:relative;top:0px;left:2px;width:679px;height:41px;" #dis#>#v#</textarea>
				</td>
			</tr>
			<cfif session.user_level is 0 AND session.user_power is 1 AND isBSS><cfset dis="disabled"></cfif><!--- Added for BSS bonus power reset --->
	...
	<cfloop index="j" from="1" to="#lngth1#">
		...
		<tr>
			...
			<table cellpadding="0" cellspacing="0" border="0" style="width:100%;">
				...
				<tr><td style="height:2px;"></td></tr>
				<!--- <tr><th style="height:5px;" colspan="11"></th></tr>
				<tr><td style="height:2px;"></td></tr> --->
				<tr>
					<th class="left middle" style="height:30px;">Tree Removal Contractor:&nbsp;</th>
					<td style="width:2px;"></td>
					<cfset v = ""><cfif trim(getTreeInfo.tree_removal_contractor) is not "">
					<cfset v = trim(getTreeInfo.tree_removal_contractor)></cfif>
					<td class="frm left middle" colspan="5"><input type="Text" name="tree_trc" id="tree_trc" value="#v#" 
					style="width:520px;" class="rounded"></td>
					<td></td>
					<th class="left middle" colspan="4">
				</tr>
				...
				<tr>
					...
					<td class="frm left middle" colspan="5"><input type="Text" name="tree_tpc" id="tree_tpc" value="#v#" 
					style="width:520px;" class="rounded"></td>
					<td></td>
					<th class="left middle" colspan="4">
				</tr>
				...
				<tr>
					...
					<td class="frm left middle" colspan="5"><input type="Text" name="tree_twc" id="tree_twc" value="#v#" 
					style="width:520px;" class="rounded"></td>
					<td></td>
					<th class="left middle" colspan="4">
				</tr>
...
<cfset w_box = 590>
	<cfset w_msg = 515><cfset h_msg = 345> <!--- 775 for testing --->
	<cfif session.user_level is 0><cfset h_msg = 175></cfif> <!--- added for BSS adding uploads --->
		...
		<div class="box_body" style="margin: 4px 0px 0px 0px;overflow:hidden;">
			<div id="attach_form" class="mn_toolbox" style="top:-3px;left:1px;height:#h_msg-30#px;width:#w_msg-10#px;overflow:hidden;">
				...
				<table align="center" border="0" cellpadding="0" cellspacing="0" width="100%" style="position:absolute;top:#f_t#px;width:100%;">
					...
					<tr><th class="left" style="padding:#pd#px 0px 0px 17px"><strong style="position:relative;top:-23px;">Tree Removal Permit PDF:</strong></th></tr>
					<tr><td align="center">
					<div id="fi_header_rmvl" class="file_header" style="position:absolute;top:#15+4*dt#px;left:#lft#px;width:80px;display:block;">File to Upload:</div>
					<div id="fi_mask_rmvl" class="fileinputs" style="top:#16+4*dt#px;left:#lft+90#px;display:block;">
					...
					<input id="file_rmvl" name="file_rmvl" type="file" class="file" style="top:#15+4*dt#px;left:#lft+90#px;display:block;" onchange="setFileName('rmvl');return false;" onclick="$('#chr(35)#attach_msg').hide();" /></div>
					...
					<tr><th class="left" style="padding:#pd#px 0px 0px 17px"><strong style="position:relative;top:-28px;">Arborist Report PDF:</strong></th></tr>
					<tr><td align="center">
					<div id="fi_header_arb" class="file_header" style="position:absolute;top:#15+5*dt#px;left:#lft#px;width:80px;display:block;">File to Upload:</div>
					<div id="fi_mask_arb" class="fileinputs" style="position:absolute;top:#16+5*dt#px;left:#lft+90#px;display:block;">
					...
					<input id="file_arb" name="file_arb" type="file" class="file" style="top:#15+5*dt#px;left:#lft+90#px;display:block;" onchange="setFileName('arb');return false;" onclick="$('#chr(35)#attach_msg').hide();" /></div>
					...
					<tr><td align="center">
					<div id="fi_header_arb" class="file_header" style="position:absolute;top:#15+dt#px;left:#lft#px;width:80px;display:block;">File to Upload:</div>
					<div id="fi_mask_arb" class="fileinputs" style="position:absolute;top:#16+dt#px;left:#lft+90#px;display:block;">
					<div id="fi_arb" style="position:relative;top:1px;width:800px;display:block;text-align:left;"></div>
					</div>
					<div id="fi_div_arb" style="display:block;">
					<input id="file_arb" name="file_arb" type="file" class="file" style="top:#15+dt#px;left:#lft+90#px;display:block;" onchange="setFileName('arb');return false;" onclick="$('#chr(35)#attach_msg').hide();" /></div>
					<a id="fi_btn_arb" href="" class="button buttonText" tabindex="3"
...
function openTreeForm() {
	...
	if ($('#sw_curbramp').val() == 0) { $('#box_tree').show(); toggleArrows(); }
	...
	intervalId = setInterval(function() {
	    ...
	    //make this the last check in your set interval function
	     if ( counter > 60 || goBool == true ) {
			  ...
			  finishUploadFiles(msg,doArb,doRmvl,doCert,doCurb,doMemo,doRoe,dir);
	     }
	//end setInterval
    } , 1000);
...
function finishUploadFiles(msg,doArb,doRmvl,doCert,doCurb,doMemo,doRoe,dir){
