  ...
  <tr>
    <td>
	    <table width="100%" border="0" cellspacing="0" cellpadding="0">
		  ...
		  <a href="swSiteEdit.cfm?sid=#getMaxSite.id##x#&search=#search#"><img src="../images/arrow_left.png" width="20" height="29" title="Previous Location"></a>
		  <!--- </cfif> --->
		  </cfif>
		  </td>
		  ...
		  <!--- <cfif session.user_level gt 0> --->
		  <cfset x = ""><cfif url.pid gt 0><cfset x = "&pid=" & url.pid></cfif>
		  <a href="swSiteEdit.cfm?sid=#getMinSite.id##x#&search=#search#"><img src="../images/arrow_right.png" width="20" height="29" title="Next Location"></a>
		  <!--- </cfif> --->
		  </td>
		  </cfif>
		  </tr>
		...
		<tr>
			<th class="drk left middle" colspan="4" style="height:30px;padding:0px 0px 0px 0px;">
					...
					<table cellpadding="0" cellspacing="0" border="0">
						...
						<cfif session.user_level gt 0><cfset w0 = 74><cfelse><cfset w0 = 222></cfif>
			...
			<tr>	
				<td colspan="4" style="padding:0px 0px 0px 0px;">
					<table cellpadding="0" cellspacing="0" border="0">
						<tr>
						<th class="left middle" style="width:185px;">No. Trees to Remove per Arborist:</th>
						<td style="width:2px;"></td>
						<cfset v = "">
						...
						<input type="Text" name="sw_no_trees" id="sw_no_trees" value="#v#" style="width:146px;text-align:center;" class="rounded" #dis#></td>
						<cfset dis = distmp>
						<td style="width:2px;"></td>
		...
		<tr>
			<th class="drk left middle" colspan="9" style="height:30px;padding:0px 0px 0px 0px;">
					...
					<table cellpadding="0" cellspacing="0" border="0">
						...
						<td class="left middle pagetitle" style="width:410px;font-size: 12px;padding:1px 3px 0px 0px;">Loc No: #getSite.location_no# - #getSite.name#
						</td>
			...
			<tr>
				...
				<th class="center middle" style="height:30px;width:100px;">
					...
					<img style="position:relative;top:1px;" src="../images/clear.png" width="16" height="16" title="Clear Contractor's Unit Prices">
						...
						<img style="position:relative;top:1px;left:0px;" src="../images/accept.png" width="14" height="14" title="Apply Contractor's Unit Prices to All Locations Within this Bid Package">
						</a>
						</td>
...
<div id="msg_all" class="box" style="top:40px;left:1px;width:480px;height:154px;display:none;z-index:505;">
	...
	<div class="box_body" style="margin: 4px 0px 0px 0px;width:100%;">
		...
		This will update the Contractor Pricing data for ALL locations in this Bid Package (#sw_grp#-#sw_pid#).
		...
		<br>You will need to go to each individual Location to calculate the cost.
	...
	<td cellspacing="0" cellpadding="0" border="0" bgcolor="white" bordercolor="white">
		...
		<cfloop query="getFlds3">			
			<cfif cnt gt 1>
				...
				<cfif c is "" AND data_type is not "nvarchar" AND data_type is not "datetime"><cfset c = ""></cfif>
...
function expandTextArea(tarea,rows) {
	var l = $('#' + tarea).val().split("\n").length;
	console.log(l);
	if (l > rows) { rows = l; }
	$('#' + tarea).height((rows*14)+5);
}
