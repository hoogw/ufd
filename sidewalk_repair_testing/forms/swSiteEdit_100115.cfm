			...
			<tr>	
				<td colspan="4" style="padding:0px 0px 0px 0px;">
					<table cellpadding="0" cellspacing="0" border="0">
						...
						<select name="sw_severity" id="sw_severity" class="rounded" style="width:40px;" #dis#>
						<option value=""></option>
			...
			<tr>	
				<td colspan="4" style="padding:0px 0px 0px 0px;">
					<table cellpadding="0" cellspacing="0" border="0">
						...
						<td class="frm"  style="width:94px;">
						<input type="Text" name="sw_con_start" id="sw_con_start" value="#v#" style="width:89px;text-align:center;" class="rounded" #dis#>
						</td>
						<td style="width:2px;"></td>
						...
						<input type="Text" name="sw_con_comp" id="sw_con_comp" value="#v#" style="width:115px;text-align:center;" class="rounded" #dis#>
						</td>
						<td style="width:2px;"></td>
						...
						<td class="frm" style="width:124px;">
						<input type="Text" name="sw_antdate" id="sw_antdate" value="#v#" style="width:119px;text-align:center;" class="rounded" #dis#></td>
						</tr>
					</table>
				</td>
			</tr>
