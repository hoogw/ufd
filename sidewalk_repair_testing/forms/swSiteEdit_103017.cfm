		...
		<td colspan="2" style="padding:0px;">
			...
			<tr>
				...
				<table cellpadding="0" cellspacing="0" border="0" style="width:100%;">
					...
					<td style="width:2px;"></td>
					<th class="left middle" style="width:200px;"><span style="font-size:10px;">Address:</span></th>
					<td style="width:2px;"></td>
					<th class="left middle" style="width:128px;"><span style="font-size:10px;">Species:</span></th>		
					<td style="width:2px;"></td>
				...
				<table cellpadding="0" cellspacing="0" border="0" style="width:100%;">
					...
					<cfif trim(getList.address) is not ""><cfset v = trim(getList.address)></cfif>
					<cfif getList.recordcount is 0><cfset v = getSite.address></cfif>
					<td class="frm left middle" style="width:201px;"><input type="Text" name="tpaddr_#scnt#_#trcnt#" id="tpaddr_#scnt#_#trcnt#" value="#v#" 
					style="width:198px;height:20px;padding:0px 2px 0px 4px;font-size:10px;" class="roundedsmall" #trdis#></td>
					<td style="width:2px;"></td>
					<td class="frm left middle" style="width:129px;">
					<div class="ui-widget">
					<cfset v = ""><cfif trim(getList.species) is not ""><cfset v = trim(getList.species)></cfif>
  					<label for="tp_species_#scnt#_#trcnt#"></label>
					<input type="Text" name="tpspecies_#scnt#_#trcnt#" id="tpspecies_#scnt#_#trcnt#" value="#v#" 
					style="width:126px;height:20px;padding:0px 2px 0px 4px;font-size:9px;" class="roundedsmall" #trdis#>
					</div>
					</td>	
					...
					<div id="tpnotediv_#scnt#_#trcnt#" style="position:absolute;height:30px;width:400px;top:-2px;left:-434px;border:0px red solid;background:white;display:none;">
