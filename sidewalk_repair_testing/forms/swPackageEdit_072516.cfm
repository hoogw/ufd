...
<table cellspacing="0" cellpadding="0" border="0" class="frame" align="center" style="width:800px;">
	...
	<td cellspacing="0" cellpadding="0" border="0" bgcolor="white" bordercolor="white">
		...
		<tr>
			<th class="drk left middle" colspan="4" style="height:30px;padding:0px 0px 0px 0px;width:800px;">
					...
					<table cellpadding="0" cellspacing="0" border="0">
						...
						<td align="left" style="width:332px;">
							...
							<cfif session.user_level is 0 AND session.user_power is 1 AND ucase(getPackage.contractor) is "BSS"><!--- Added for BSS bonus power --->
							<a href="" class="button buttonText" style="height:17px;width:80px;padding:3px 0px 0px 0px;" 
							onclick="submitForm();return false;">Update</a>
							</cfif>
						</td>
			...
			<cfif session.user_level is 0 AND session.user_power is 1 AND ucase(getPackage.contractor) is "BSS"><cfset dis=""></cfif><!--- Added for BSS bonus power --->
			<tr>	
			...
			<tr>	
				<td colspan="4" style="padding:0px 0px 0px 0px;">
					<table cellpadding="0" cellspacing="0" border="0">
						...
						<input type="Text" name="sw_contractor" id="sw_contractor" value="#v#" style="width:#w2+176#px;" class="rounded" #dis# #bssdis#></td>
						</tr>
					</table>
				</td>
			</tr>
				...
				<td colspan="4" style="padding:0px 0px 0px 0px;">
					...
					<table cellpadding="0" cellspacing="0" border="0">
						...
						<cfloop query="getSites">
							...
							<cfif session.user_power is 1 AND session.user_level is 0 AND ucase(getPackage.contractor) is "BSS">
