		...
		<td colspan="2" style="padding:0px;">
			...
			<tr>
				...
				<table cellpadding="0" cellspacing="0" border="0" style="width:100%;">
					...
					style="width:197px;height:20px;padding:0px 2px 0px 4px;" class="roundedsmall" #trdis#></td>	
					</div>
				</table>
				</div>
				</cfloop>
			...
			<tr>
				...
				<table cellpadding="0" cellspacing="0" border="0" style="width:100%;">
					...
					style="width:183px;height:20px;padding:0px 2px 0px 4px;" class="roundedsmall" #trdis#></td>	
					</div>
				</table>
				</div>
				</cfloop>
