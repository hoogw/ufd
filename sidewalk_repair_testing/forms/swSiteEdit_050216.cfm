...
<cfset arrDisabledTrees[5] = "TREE_REMOVAL__6_INCH_TO_24_INCH_DIAMETER__">
<cfset arrDisabledTrees[6] = "TREE_REMOVAL__OVER_24_INCH_DIAMETER__">
		...
		<tr>
			<th class="drk left middle" colspan="4" style="height:30px;padding:0px 0px 0px 0px;">
					...
					<table cellpadding="0" cellspacing="0" border="0">
						...
						<td class="left middle pagetitle" style="width:205px;padding:1px 3px 0px 0px;"><span onmouseover="this.style.cursor='pointer';" onclick="goToPackage(#x#);return false;">#sw_grp# - #sw_pid#</span>
						</td>
						<cfelse>
						<th class="drk left middle" style="width:280px;"></th>
						</td>
						</cfif>
						...
						<cfif getSite.removed is "">
							...
							<td align="right" style="width:28px;">
							<a href="" onclick="openTreeForm();toggleArrows();return false;" style="position:relative;top:0px;">
			...
			<tr>
				...
				<th class="left middle" style="width:93px;">Type:</th>
				<td class="frm"  style="width:182px;">
				<select name="sw_type" id="sw_type" class="rounded" style="width:181px;" #dis#>
				<option value=""></option>
			...
			<tr>	
				<td colspan="4" style="padding:0px 0px 0px 0px;">
					<table cellpadding="0" cellspacing="0" border="0">
						...
						<input type="Text" name="sw_priority" id="sw_priority" value="1" style="width:35px;text-align:center;" class="rounded" #dis#></td>
						<td style="width:2px;"></td>
			...
			<tr>	
				<td colspan="4" style="padding:0px 0px 0px 0px;">
					<table cellpadding="0" cellspacing="0" border="0">
						...
						<td class="frm" style="width:117px;">
						<input type="Text" name="sw_assessor" id="sw_assessor" value="#v#" style="width:112px;" class="rounded" #dis#></td>
						<td style="width:2px;"></td>
						...
						<td style="width:2px;"></td>
						<th class="left middle" style="height:30px;width:54px;">Severity<br>Index:</th>
						<td style="width:2px;"></td>
						<td class="frm"  style="width:60px;">
						<select name="sw_severity" id="sw_severity" class="rounded" style="width:55px;" #dis#>
						<option value=""></option>
			...
			<tr>	
				<td colspan="4" style="padding:0px 0px 0px 0px;">
					<table cellpadding="0" cellspacing="0" border="0">
						<tr>
						<th class="left middle" style="width:215px;">Number of Trees to Remove per Arborist:</th>
						<td style="width:2px;"></td>
						<cfset v = "">
						...
						<td class="frm" style="width:91px;">
						<cfset distmp = dis>
						<cfif getSite.curb_ramp_only is 1><cfset dis = "disabled"></cfif>
						<input type="Text" name="sw_no_trees" id="sw_no_trees" value="#v#" style="width:86px;text-align:center;" class="rounded" disabled></td>
						<cfset dis = distmp>
						<td style="width:2px;"></td>
						<th class="left middle" style="height:30px;width:366px;"></th>
						<!--- <td style="width:2px;"></td>
			...
			<tr><th class="left middle" colspan="4" style="height:20px;">
			...
			<tr>
				...
				<cfset distmp = dis>
				<cfif getSite.curb_ramp_only is 1><cfset dis = "disabled"></cfif>
				<textarea id="sw_tree_notes" class="rounded" style="position:relative;top:0px;left:2px;width:679px;height:41px;" disabled <!--- #dis# --->>#v#</textarea>
				<cfset dis = distmp>
				</td>
			</tr>
			...
			<tr><th class="left middle" colspan="4" style="height:20px;">
				<table cellpadding="0" cellspacing="0" border="0" style="width:100%;">
					<tr><th class="left middle" style="padding:1px 0px 0px 0px">Notes:</th>
					<td class="right" style="padding:0px;"><a href="" onclick="expandTextArea('sw_notes',2,14);return false;" style="position:relative;top:1px;right:8px;"><img src="../images/fit.png" width="13" height="13"  title="Expand to View All Text"></a></td></tr>
				</table>
			</th></tr>
			<tr>
				...
				<!--- <cfset distmp = dis>
				<cfif getSite.curb_ramp_only is 1><cfset dis = "disabled"></cfif> --->
				<textarea id="sw_notes" class="rounded" style="position:relative;top:0px;left:2px;width:679px;height:41px;" #dis#>#v#</textarea>
				<!--- <cfset dis = distmp> --->
				</td>
			</tr>
			...
			<tr><th class="left middle" colspan="4" style="height:20px;">
				<table cellpadding="0" cellspacing="0" border="0" style="width:100%;">
					<tr><th class="left middle" style="padding:1px 0px 0px 0px">Site Description:</th>
					<td class="right" style="padding:0px;"><a href="" onclick="expandTextArea('sw_loc',2,14);return false;" style="position:relative;top:1px;right:8px;"><img src="../images/fit.png" width="13" height="13" title="Expand to View All Text"></a></td></tr>
				</table>
			</th></tr>
			<tr>
				<cfset v = getSite.location_description>
				<td class="frm" colspan="4" style="height:42px;">
				<textarea id="sw_loc" class="rounded" style="position:relative;top:0px;left:2px;width:679px;height:41px;" #dis#>#v#</textarea>
				</td>
			</tr>
			
			<tr><th class="left middle" colspan="4" style="height:20px;">
				<table cellpadding="0" cellspacing="0" border="0" style="width:100%;">
					<tr><th class="left middle" style="padding:1px 0px 0px 0px">Damage Description:</th>
					<td class="right" style="padding:0px;"><a href="" onclick="expandTextArea('sw_damage',2,14);return false;" style="position:relative;top:1px;right:8px;"><img src="../images/fit.png" width="13" height="13"  title="Expand to View All Text"></a></td></tr>
				</table></th></tr>
			<tr>
				<cfset v = getSite.damage_description>
				<td class="frm" colspan="4" style="height:42px;">
				<textarea id="sw_damage" class="rounded" style="position:relative;top:0px;left:2px;width:679px;height:41px;" #dis#>#v#</textarea>
				</td>
			</tr>
		...
		<tr>
			<th class="drk left middle" colspan="2" style="height:30px;padding:0px 0px 0px 0px;">
					...
					<table cellpadding="0" cellspacing="0" border="0">
						...
						<td align="center">
							<a href="" class="button buttonText" style="height:17px;width:80px;padding:3px 0px 0px 0px;" 
							onclick="resetForm2();toggleArrows();return false;">Cancel</a>
						</td>
	...
	<td cellspacing="0" cellpadding="0" border="0" bgcolor="white" bordercolor="white">
		...
		<tr>
			<th class="drk left middle" colspan="9" style="height:30px;padding:0px 0px 0px 0px;">
					...
					<table cellpadding="0" cellspacing="0" border="0">
						<tr>
						<th class="drk left middle" style="width:130px;"><!--- Site Number --->Field Assessment:</th>
						<td class="left middle pagetitle" style="width:350px;font-size: 12px;padding:1px 3px 0px 0px;">Site No: #getSite.location_no# - #getSite.name#
						</td>
			...
			<tr>
				...
				<cfif find("EXTRA_FIELD",column_name,"1") gt 0>
					...
					<th class="left middle" style="height:30px;width:320px;">
						...
						style="position:relative;top:0px;width:#xx#px;height:22px;padding: 2px 5px 2px 5px;font-size:10px;" class="roundedsmall" maxlength="100" tabindex="#tab1#">
						</th>
						<cfset tab1 = tab1+1>
						</tr></table>
					</th>
				...
				style="width:65px;text-align:center;" class="center rounded" tabindex="#tab3#" maxlength="7"></td>
				<cfset tab3 = tab3+1>
				...
				style="width:67px;text-align:center;" class="center rounded" tabindex="#tab4#" onkeyup="addTotal('#fld#');" #treedis#></td>
				<cfset tab4 = tab4+1>
		...
		<tr>
			<th class="drk left middle" colspan="11" style="height:30px;padding:0px 0px 0px 0px;">
					...
					<table cellpadding="0" cellspacing="0" border="0">
						...
						<td align="right" style="width:307px;">
							<!--- <cfif session.user_level gt 0 AND session.user_power gte 0> --->
							<cfif session.user_power is 3>
							<a href="" class="button buttonText" style="height:17px;width:80px;padding:3px 0px 0px 0px;" 
		...
		<td colspan="2" style="padding:0px;">
			...
			<tr>
				...
				<table cellpadding="0" cellspacing="0" border="0" style="width:100%;">
					...
					<td style="width:2px;"></td>
					<th class="left middle" style="width:260px;">Address:</th>
					<td style="width:2px;"></td>
					<th class="left middle" style="width:184px;">Species:</th>	
					<td style="width:2px;"></td>
					<th class="left middle" style="">Type:</th>	
				</table>
				...
				<table cellpadding="0" cellspacing="0" border="0" style="width:100%;">
					...
					<td class="frm left middle" style="width:261px;"><input type="Text" name="traddr_#scnt#_#trcnt#" id="traddr_#scnt#_#trcnt#" value="#v#" 
					style="width:258px;height:20px;padding:0px 2px 0px 4px;" class="roundedsmall" #trdis#></td>
					<td style="width:2px;"></td>
					<td class="frm left middle" style="width:185px;">
					<div class="ui-widget">
					...
					style="width:182px;height:20px;padding:0px 2px 0px 4px;" class="roundedsmall" #trdis#>
					</div>
					</td>	
					<td style="width:2px;"></td>
					<td class="frm left middle">
					<select name="trtype_#scnt#_#trcnt#" id="trtype_#scnt#_#trcnt#" class="roundedsmall" style="width:105px;height:20px;" #trdis#>
					<!--- <option value=""></option> --->
			...
			<tr>
				...
				<table cellpadding="0" cellspacing="0" border="0" style="width:100%;">
					...
					<td style="width:2px;"></td>
					<th class="center middle" style="width:59px;">Box Size:</th>
					<td style="width:2px;"></td>
					<th class="center middle" style="width:80px;"><span style="font-size:10px;">Permit Issuance<br>Date:</span></th>
					<td style="width:2px;"></td>
					<th class="center middle" style="width:70px;"><span style="font-size:10px;">Tree Planting<br>Date:</span></th>
					<td style="width:2px;"></td>
					<th class="center middle" style="width:70px;"><span style="font-size:10px;">Start Watering<br>Date:</span></th>
					<td style="width:2px;"></td>
					<th class="center middle" style="width:70px;"><span style="font-size:10px;">End Watering<br>Date:</span></th>
					<td style="width:2px;"></td>
					<th class="left middle" style="width:240px;">Address:</th>
					<td style="width:2px;"></td>
					<th class="left middle" style="width:170px;">Species:</th>		
					<td style="width:2px;"></td>
					<th class="left middle" >Type:</th>	
				</table>
				...
				<table cellpadding="0" cellspacing="0" border="0" style="width:100%;">
					...
					<td style="width:2px;"></td>
					<td class="frm left middle" style="width:58px;">
					<select name="tpdia_#scnt#_#trcnt#" id="tpdia_#scnt#_#trcnt#" class="roundedsmall" style="width:55px;height:20px;" #trdis#>
					<cfloop index="i" from="1" to="#arrayLen(arrDia)#">
						<cfset sel = ""><cfif arrDia[i] is v><cfset sel = "selected"></cfif>
					...
					<cfset v = ""><cfif trim(getList.permit_issuance_date) is not "">
					<cfset v = dateformat(trim(getList.permit_issuance_date),"mm/dd/yyyy")></cfif>
					<td class="frm left middle" style="width:79px;"><input type="Text" name="tppidt_#scnt#_#trcnt#" id="tppidt_#scnt#_#trcnt#" value="#v#" 
					style="width:76px;height:20px;padding:0px;" class="center roundedsmall" #trdis#></td>
					<td style="width:2px;"></td>
					<cfset v = ""><cfif trim(getList.tree_planting_date) is not "">
					<cfset v = dateformat(trim(getList.tree_planting_date),"mm/dd/yyyy")></cfif>
					<td class="frm left middle" style="width:69px;"><input type="Text" name="tptrdt_#scnt#_#trcnt#" id="tptrdt_#scnt#_#trcnt#" value="#v#" 
					...
					<td class="frm left middle" style="width:69px;"><input type="Text" name="tpswdt_#scnt#_#trcnt#" id="tpswdt_#scnt#_#trcnt#" value="#v#" 
					style="width:66px;height:20px;padding:0px;" class="center roundedsmall" #trdis#></td>
					<td style="width:2px;"></td>
					<cfset v = ""><cfif trim(getList.end_watering_date) is not "">
					<cfset v = dateformat(trim(getList.end_watering_date),"mm/dd/yyyy")></cfif>
					<td class="frm left middle" style="width:69px;"><input type="Text" name="tpewdt_#scnt#_#trcnt#" id="tpewdt_#scnt#_#trcnt#" value="#v#" 
					style="width:66px;height:20px;padding:0px;" class="center roundedsmall" #trdis#></td>
					<td style="width:2px;"></td>
					<cfset v = "">
					<cfif trim(getList.address) is not ""><cfset v = trim(getList.address)></cfif>
					...
					style="width:168px;height:20px;padding:0px 2px 0px 4px;" class="roundedsmall" #trdis#>
					</div>
					</td>	
					<td style="width:2px;"></td>
					<td class="frm left middle">
					<select name="tptype_#scnt#_#trcnt#" id="tptype_#scnt#_#trcnt#" class="roundedsmall" style="width:105px;height:20px;" #trdis#>
					<!--- <option value=""></option> --->
					<cfloop query="getTreeTypes">
						<cfset sel = ""><cfif getList.type is id><cfset sel = "selected"></cfif>
						<option value="#id#" #sel#>#value#</option>
		...
		<tr>
			...
			<table cellpadding="0" cellspacing="0" border="0" style="width:100%;">
				...
				<tr>
					...
					style="width:363px;" class="rounded"></td>
				...
				<tr>
					...
					<textarea id="tree_trn" class="rounded" style="position:relative;top:0px;left:2px;width:936px;height:69px;">#v#</textarea>
					</td>
				</tr>
...
<div id="msg5" class="box" style="top:40px;left:1px;width:380px;height:144px;display:none;z-index:505;">
	...
	<cfset w_box = 590>
	<cfset w_msg = 515><cfset h_msg = 175> <!--- 675 for testing --->
	...
	<div id="attachments" class="box" style="top:1px;left:#l_msg-5#px;width:#w_msg#px;height:#h_msg#px;display:none;z-index:910;">
		...
		<div class="box_body" style="margin: 4px 0px 0px 0px;overflow:hidden;">
			<div id="attach_form" class="mn_toolbox" style="top:-3px;left:1px;height:#h_msg-30#px;width:#w_msg-10#px;overflow:hidden;">
				...
				<cfset f_t = 45><cfset p = 2><cfset ht = 14><cfset lft = 12><cfset pd = 35>
				...
				<table align="center" border="0" cellpadding="0" cellspacing="0" width="100%" style="position:absolute;top:#f_t#px;width:100%;">
					...
					<tr><th class="left" style="padding:#pd#px 0px 0px 17px"><strong style="position:relative;top:-8px;">Arborist Report PDF:</strong></th></tr>
					<tr><td align="center">
					<div id="fi_header_arb" class="file_header" style="position:absolute;top:57px;left:#lft#px;width:80px;display:block;">File to Upload:</div>
					<div id="fi_mask_arb" class="fileinputs" style="position:absolute;top:58px;left:#lft+90#px;display:block;">
					...
					<input id="file_arb" name="file_arb" type="file" class="file" style="top:57px;left:#lft+90#px;display:block;" onchange="setFileName('arb');return false;" onclick="$('#chr(35)#attach_msg').hide();" /></div>
					...
					<tr><td><iframe id="attach_iframe" name="attach_iframe" style="display:none;position:relative;top:30px;left:0px;height:500px;width:500px;border:0px red solid;"></iframe></td></tr>
					</form>
				</table>
			</div>
		</div>
...
function openTreeForm() {
	...
	if ($('#sw_curbramp').val() == 0) { $('#box_tree').show(); }
	...
	intervalId = setInterval(function() {
	    ...
	    //make this the last check in your set interval function
	     if ( counter > 60 || goBool == true ) {
			  ...
			  finishUploadFiles(msg,doArb,doRmvl,dir);
	     }
	//end setInterval
    } , 1000);
...
function finishUploadFiles(msg,doArb,doRmvl,dir){
