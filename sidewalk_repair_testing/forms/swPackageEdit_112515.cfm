    ...
    <td>
	    <table width="100%" border="0" cellspacing="0" cellpadding="0">
		  ...
		  <cfelse>
			  ...
			  <a href="../reports/Bidding.cfm?my_package=#getPackage.package_group#-#getPackage.package_no#" target="_blank"><img style="position:relative;top:-2px;left:15px;" src="../images/report.png" width="20" height="20" title="Contractor Bid Form"></a>
			  </td></tr>
		  </cfif>
		</table>
  	</td>
			...
			<tr>	
				<td colspan="4" style="padding:0px 0px 0px 0px;">
					<table cellpadding="0" cellspacing="0" border="0">
						...
						<input type="Text" name="sw_est" id="sw_est" value="#trim(v)#" style="width:88px;" class="center rounded" disabled>
...
<table cellspacing="0" cellpadding="0" border="0" class="frame" align="center" style="width:753px;">
	<tr>	
		<td cellspacing="0" cellpadding="0" border="0" bgcolor="white" bordercolor="white">
			<table align=center bgcolor=white cellspacing="2" cellpadding="2" border="0">
				<td colspan="4" style="padding:0px 0px 0px 0px;">
