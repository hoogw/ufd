...
<cfquery name="MyQuery" datasource="sidewalk">
	SELECT    wo.Package, wo.Package_No, wo.Package_Group, wo.Engineers_Estimate, wo.Work_Order, wo.NFB_Date, wo.Bids_Due_Date, wo.Construct_Order_Date, wo.Precon_Meeting_Date, wo.Notice_To_Proceed_Date, 
	wo.Awarded_Bid, wo.Contractor, wo.Deleted, a.Location_No, a.Name, a.Council_District, a.Construction_Start_Date, a.Construction_Completed_Date, 
	e.[4_INCH_SIDEWALK_QUANTITY], e.[6_INCH_DRIVEWAY_AND_SIDEWALK_QUANTITY], e.[8_INCH_DRIVEWAY_AND_SIDEWALK_HIGH_EARLY_STRENGTH_QUANTITY], wo.Notes
