...
with goodtree( Location_No, TREE_REMOVAL_DATE, SPECIES, TREE_PLANTING_DATE, START_WATERING_DATE, END_WATERING_DATE, ACTION_TYPE, ADDRESS, TREE_BOX_SIZE   ) as (
	select vwHDRTreeList.Location_No, TREE_REMOVAL_DATE, SPECIES, TREE_PLANTING_DATE, START_WATERING_DATE, END_WATERING_DATE, ACTION_TYPE, vwHDRTreeList.ADDRESS, TREE_BOX_SIZE 
	from vwHDRTreeList
