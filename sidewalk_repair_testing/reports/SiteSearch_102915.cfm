...
SELECT location_no,package,name,address,construction_start_date,
construction_completed_date,priority_no,type_desc as type,work_order FROM session.siteQuery
</cfquery>
