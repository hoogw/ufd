<cfapplication name="sidewalk_rpr" clientmanagement="Yes" sessionmanagement="Yes" sessiontimeout="#Createtimespan(999999,0,0,0)#" applicationtimeout="#Createtimespan(99999999999,0,0,0)#">
...
<cfset request.dir="\\78boe99prod\ufd\trees1">
<cfset request.server="http://78boe99prod">
<cfset request.url="http://78boe99prod/ufd/trees1/">
