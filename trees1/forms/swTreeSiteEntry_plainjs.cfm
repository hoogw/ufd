...
<!--- Get Program Type --->
<cfquery name="getType" datasource="#request.sqlconn2#" dbtype="ODBC">
			...
			<tr>
				...
				<td colspan="4" style="padding:0px 0px 0px 0px;">
					<table cellpadding="0" cellspacing="0" border="0">
						...
						<select name="sw_site_no" id="sw_site_no" class="rounded" style="width:85px;" onChange="site_no_change()" disabled>
						    <option value=""></option>
						...
						<input type="Text" name="sw_cd" id="sw_cd" value="" style="width:59px;" class="rounded" disabled>
						</td>
						</tr>
					</table>
				</td>
