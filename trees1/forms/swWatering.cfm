...
<script language="JavaScript1.2" src="../js/swWatering.js"></script>
...
<!--- Get Program Type --->
<cfquery name="getType" datasource="UFD_Inventory" dbtype="ODBC">
  ...
  <tr>
    <td>
	    <table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr><td align="center" class="pagetitle">Watering</td></tr>
		  <tr><td height="15"></td></tr>
		</table>
  	</td>
  </tr>
		...
		<tr>
			<th class="drk left middle" colspan="4" style="height:30px;padding:0px 0px 0px 0px;">
					...
					<table cellpadding="0" cellspacing="0" border="0">
						<tr>
							<th class="drk left middle" style="width:527px;">Watering:</th>
			...
			<tr>
				...
				<td colspan="4" style="padding:0px 0px 0px 0px;">
					<table cellpadding="0" cellspacing="0" border="0">
						<tr>
						<th class="left middle" style="height:30px;width:86px;">Program Type:</th>
						<td style="width:2px;"></td>
						<td class="frm"  style="width:150px;">
						<select name="sw_type" id="sw_type" class="rounded" style="width:145px;"  onchange="program_type_change()">
                        	<option value=""></option>
						...
						<select name="sw_pkg_no" id="sw_pkg_no" class="rounded" style="width:55px;" onChange="package_no_change()" disabled>
						  <option value=""></option>
						...
						<select name="sw_site_no" id="sw_site_no" class="rounded" style="width:85px;" disabled>
						    <option value=""></option>
						...
						<input type="Text" name="sw_cd" id="sw_cd" value="" style="width:59px;" class="rounded">
						</td>
						</tr>
					</table>
				</td>
            ...
            <tr>
                    ...
                    <td class="frm"  style="width:185px;">
                        <input type="Text" name="sw_rebate" id="sw_rebate" value="" style="width:184px;" class="rounded"></td>
                    </td>
                <th class="left middle" style="height:30px;width:85px;">CRM Number:</th>
				
                
                <td class="frm"  style="width:295px;">
				<input type="Text" name="sw_crm" id="sw_crm" value="" style="width:293px;" class="rounded"></td>
