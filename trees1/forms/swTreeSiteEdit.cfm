...
<!---  our js --->
<script language="JavaScript" src="../js/swTreeSiteEdit.js"></script>
  ...
  <tr>
    <td>
	    <table width="100%" border="0" cellspacing="0" cellpadding="0">
		  ...
		  <td align="center" class="pagetitle">Update Tree Replacement and Watering Site</td>
		  <td style="width:25%;">
			...
			<tr>	
				<td colspan="4" style="padding:0px 0px 0px 0px;">
					<table cellpadding="0" cellspacing="0" border="0">
						...
						<cfset dis = distmp>
						<td style="width:2px;"></td>
						<th class="left middle" style="width:239px;">
						...
						<td style="width:2px;"></td>
						<th class="left middle" style="width:120px;"></th>
						<cfset dis = distmp>
						</tr>
					</table>
				</td>
...
<table align=center border="0" cellpadding="0" cellspacing="0">
	    ...
	    End main form1  include update button --->
...
<table cellspacing="0" cellpadding="0" border="0" class="frame" align="center" style="width:950px;">
    ...
    <cfloop index="j" from="1" to="#lngth1#">
		...
		<td colspan="2" style="padding:0px;">
			...
			<tr><td style="height:2px;"></td></tr>
                ...
                <cfset max_trcnt_0 = 0><cfif chkList.recordcount gt 0><cfset max_trcnt_0 = chkList.mx></cfif>
			...
			<tr><th class="drk left middle" colspan="2" style="height:20px;padding:0px;">
				<table cellpadding="0" cellspacing="0" border="0" style="width:100%;">
					<tr><th class="drk left middle"><span style="position:relative;top:0px;">On Site Tree Plantings</span>
					...
					<th class="left middle" >Type:</th>	
                                            ...
                                            <cfloop index="i" from="1" to="#lngth2#">
                                                    ...
                                                    <table cellpadding="0" cellspacing="0" border="0" style="width:100%;">
                                                        ...
                                                        <select name="tpdia_#scnt#_#trcnt#" id="tpdia_#scnt#_#trcnt#" class="roundedsmall" style="width:55px;height:20px;" onChange="calcTrees();" #trdis#>
    ...
    <!---       OFF  Site planting            --->
			...
			<tr><th class="drk left middle" colspan="2" style="height:20px;padding:0px;">
				<table cellpadding="0" cellspacing="0" border="0" style="width:100%;">
					<tr><th class="drk left middle"><span style="position:relative;top:0px;">Off Site Tree Plantings</span>
					<span style="position:relative;top:0px;left:25px;">(Total: <strong><span id="tp0_tot_#scnt#" style="color:red;">#max_trcnt_0#</span></strong> )</span></th>
					<th class="drk right middle"><span style="position:relative;top:1px;">
					<cfif session.user_level gte 0 AND session.user_power gte 0>
					<a href="" onClick="addTree('add0',#scnt#);return false;"><img src="../images/add.png" width="16" height="16" title="Add Tree Planting" style="position:relative;right:4px;"></a>
					<a href="" onClick="delTree('add0',#scnt#);return false;"><img src="../images/delete.png" width="16" height="16" title="Delete Tree Planting" style="position:relative;right:2px;"></a>
					</cfif>
					</span>
					</th></tr>
				</table>
				...
				<table cellpadding="0" cellspacing="0" border="0" style="width:100%;">
					...
					<th class="left middle" >Type:</th>	
                                            ...
                                            <cfloop index="i" from="1" to="#lngth2#">
                                                    ...
                                                    <cfset vis = "block"><cfset trdis = ""><cfif i gt max_trcnt_0><cfset vis = "none"><cfset trdis = "disabled"></cfif>
                                                   
                                                    <div id="tr_add0_div_#scnt#_#trcnt#" style="display:#vis#;">
                                                    ...
                                                    <table cellpadding="0" cellspacing="0" border="0" style="width:100%;">
                                                        ...
                                                        <cfset v = 24><cfif trim(getList.tree_box_size) is not "">
                                                        <cfset v = trim(getList.tree_box_size)></cfif>
                                                        <input type="Text" name="tp0cnt_#scnt#_#trcnt#" id="tp0cnt_#scnt#_#trcnt#" value="#trcnt#" 
                                                        style="width:26px;height:20px;padding:0px;" class="center roundedsmall" disabled></td>
                                                        <td style="width:2px;"></td>
                                                        <td class="frm left middle" style="width:58px;">
                                                        <select name="tp0dia_#scnt#_#trcnt#" id="tp0dia_#scnt#_#trcnt#" class="roundedsmall" style="width:55px;height:20px;" onChange="calcTrees0();" #trdis#>
                                                        ...
                                                        <cfset v = ""><cfif trim(getList.permit_issuance_date) is not "">
                                                        <cfset v = dateformat(trim(getList.permit_issuance_date),"mm/dd/yyyy")></cfif>
                                                        <td class="frm left middle" style="width:79px;"><input type="Text" name="tp0pidt_#scnt#_#trcnt#" id="tp0pidt_#scnt#_#trcnt#" value="#v#" 
                                                        style="width:76px;height:20px;padding:0px;" class="center roundedsmall" #trdis#></td>
                                                        <td style="width:2px;"></td>
                                                        <cfset v = ""><cfif trim(getList.tree_planting_date) is not "">
                                                        <cfset v = dateformat(trim(getList.tree_planting_date),"mm/dd/yyyy")></cfif>
                                                        <td class="frm left middle" style="width:69px;"><input type="Text" name="tp0trdt_#scnt#_#trcnt#" id="tp0trdt_#scnt#_#trcnt#" value="#v#" 
                                                        style="width:66px;height:20px;padding:0px;" class="center roundedsmall" #trdis#></td>
                                                        <td style="width:2px;"></td>
                                                        <cfset v = ""><cfif trim(getList.start_watering_date) is not "">
                                                        <cfset v = dateformat(trim(getList.start_watering_date),"mm/dd/yyyy")></cfif>
                                                        <td class="frm left middle" style="width:69px;"><input type="Text" name="tp0swdt_#scnt#_#trcnt#" id="tp0swdt_#scnt#_#trcnt#" value="#v#" 
                                                        style="width:66px;height:20px;padding:0px;" class="center roundedsmall" #trdis#></td>
                                                        <td style="width:2px;"></td>
                                                        <cfset v = ""><cfif trim(getList.end_watering_date) is not "">
                                                        <cfset v = dateformat(trim(getList.end_watering_date),"mm/dd/yyyy")></cfif>
                                                        <td class="frm left middle" style="width:69px;"><input type="Text" name="tp0ewdt_#scnt#_#trcnt#" id="tp0ewdt_#scnt#_#trcnt#" value="#v#" 
                                                        style="width:66px;height:20px;padding:0px;" class="center roundedsmall" #trdis#></td>
                                                        <td style="width:2px;"></td>
                                                        <cfset v = "">
                                                        <cfif trim(getList.address) is not ""><cfset v = trim(getList.address)></cfif>
                                                        <cfif getList.recordcount is 0><cfset v = getSite.address></cfif>
                                                        <td class="frm left middle" style="width:241px;"><input type="Text" name="tp0addr_#scnt#_#trcnt#" id="tp0addr_#scnt#_#trcnt#" value="#v#" 
                                                        style="width:238px;height:20px;padding:0px 2px 0px 4px;" class="roundedsmall" #trdis#></td>
                                                        <td style="width:2px;"></td>
                                                        <td class="frm left middle" style="">
                                                        <div class="ui-widget">
                                                        <cfset v = ""><cfif trim(getList.species) is not ""><cfset v = trim(getList.species)></cfif>
                                                        <label for="tp0_species_#scnt#_#trcnt#"></label>
                                                        <input type="Text" name="tp0species_#scnt#_#trcnt#" id="tp0species_#scnt#_#trcnt#" value="#v#" 
                                                        style="width:168px;height:20px;padding:0px 2px 0px 4px;" class="roundedsmall" #trdis#>
                                                        </div>
                                                        </td>	
                                                        <td style="width:2px;"></td>
                                                        <td class="frm left middle">
                                                        <select name="tp0type_#scnt#_#trcnt#" id="tp0type_#scnt#_#trcnt#" class="roundedsmall" style="width:105px;height:20px;" #trdis#>
                                                        <!--- <option value=""></option> --->
                                                                        <cfloop query="getTreeTypes">
                                                                            <cfset sel = ""><cfif getList.type is id><cfset sel = "selected"></cfif>
                                                                            <option value="#id#" #sel#>#value#</option>
											...
											<cfset tr_add0_cnt = max_trcnt_0>
                                            <input type="Hidden" id="tr_add0_cnt_#scnt#" name="tr_add0_cnt_#scnt#" value="#tr_add0_cnt#" #sirdis#>
                                          </td>
										</tr>
    ...
    <!---                       End OFF site tree replacement planting                       --->
		...
		<tr>
			...
			<table cellpadding="0" cellspacing="0" border="0" style="width:100%;">
				...
				<tr><td style="height:2px;"></td></tr> --->
				<tr>
					<th class="left middle" style="height:30px;">Arborist Name:&nbsp;</th>
					<td style="width:2px;"></td>
					<cfset v = ""><cfif trim(getTreeInfo.arborist_name) is not "">
					<cfset v = trim(getTreeInfo.arborist_name)></cfif>
					<td class="frm left middle" colspan="5"><input type="Text" name="tree_arbname" id="tree_arbname" value="#v#" 
				...
				<tr>
					...
					style="width:520px;" class="rounded" disabled></td>
					<td></td>
					<th class="left middle" colspan="4">
				</tr>
