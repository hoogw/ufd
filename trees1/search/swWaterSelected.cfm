                                      ...
                                      <tr>
                                        <td>
                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                              ...
                                              <tr><td align="center" class="pagetitle"  style="position:relative;top:10px;color:white;">Water</td></tr>
                                        ...
                                        <tr>
                                            ...
                                            <img src="../images/excel.png" width="17" height="17"></div></td> --->
                                                ...
                                                ng-click="save_all_current_water_date()">Save</a>
                                                                                                      ...
                                                                                                      <datepicker date-format="MM/dd/yyyy" date-typer="true" style="height:17px;width:80px;padding:3px 0px 0px 0px;">
                                                                                                              
                                                                                                                    <input ng-model="all_current_water_date" type="text" style="width:75px;"
            					...
            					<!---  -------------------   ng-grid   ------------------   --->
                                 ...
                                 <div  cellspacing="0" cellpadding="0" border="0" class="frame" align="center" style=" background-color: white;">   
                                               ...
                                               <!---  
                                                ...
                                                <div id="grid" ui-grid="gridOptions" ui-grid-exporter ui-grid-selection ui-grid-edit >
                                                </div>
