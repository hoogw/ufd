...
app.controller('MainCtrl', ['$scope', '$http','$interval', '$q', 'uiGridConstants', function ($scope, $http, $interval, $q, uiGridConstants) {
                  ...
                  $scope.editLink_cd = function( grid, myRow ) {
				   ...
				   $scope.editLink_note = function( grid, myRow ) {
					   return myRow.entity.NOTES;
				  };
				...
				// -------- single filter -----------
					  ...
					  $scope.singleFilter = function( renderableRows ){
							...
							renderableRows.forEach( function( row ) {
							  var match = false;
							  ['PROGRAM_TYPE', 'BOE_BID_PACKAGE', 'BOE_SITE', 'CD','REBATE', 'CRM_NUMBER', 'NOTES' ].forEach(function( field ){
				...
				// ---- End ---- single filter -----------
									...
									//  ............... End ......... clear button clicked, clear all filter, clear all selection   .................  --->
				                       ...
				                       //  .............. customized_deep_search  ..............
				
				                       $scope.customized_deep_search = function(){
				
				                                      
													  
													  $("#customized_deep_search_modal").modal();
													  
									   }
				
				                       //  .............  .End ..... customized_deep_search  ..............
