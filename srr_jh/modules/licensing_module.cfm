...
<cfparam name="attributes.license_no" default="1016003">	<!--- The passed Contractor's license number --->

<cfset attributes.license_no =ReplaceNoCase("#attributes.license_no#"," ","","ALL")>
<cfset attributes.license_no =ReplaceNoCase("#attributes.license_no#","-","","ALL")>
<cfset attributes.license_no =ReplaceNoCase("#attributes.license_no#","/","","ALL")>
<cfset attributes.license_no =ReplaceNoCase("#attributes.license_no#",",","","ALL")>
<cfset attributes.license_no =ReplaceNoCase("#attributes.license_no#","##","","ALL")>
...
<cftry>
<cfif #request.proxy# is "y">
	<cfhttp url="https://www2.cslb.ca.gov/OnlineServices/CheckLicenseII/LicenseDetail.aspx?LicNum=#attributes.license_no#" method="GET"     proxyserver="bcproxy.ci.la.ca.us" proxyport="8080" timeout="1000"> 
<cfelse>
	<cfhttp url="https://www2.cslb.ca.gov/OnlineServices/CheckLicenseII/LicenseDetail.aspx?LicNum=#attributes.license_no#" method="GET"  timeout="1000"> 
</cfif>
<!--- <cfdump var="#cfhttp.FileContent#">  --->

<cfcatch type="Any">
<div class="warning">Unable to validate license at this time</div>
<br><br>
<div class="warning">Please try at a later time</div>
<cfmail to="essam.amarragy@lacity.org" from="eng.lapermits@lacity.org" subject="Failed to Validate Contractor's License - #attributes.license_no#">
Failed to Validate Contractor's License - #attributes.license_no#
</cfmail>
<cfabort>
</cfcatch>
</cftry>
			...
			<cfelse>
				...
				<cfelse>
					<cfif stopCity is false>
						<cfif i+1 is arrayLen(arrBusiness)>
							<cfset stopCity = true>
						...
						<cfelse>
							<cfset request.cont_address = request.cont_address & " " & arrBusiness[i]>
						</cfif>
					<cfelse>
