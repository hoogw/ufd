...
<cfparam name="attributes.hse_nbr" default="300">
<cfparam name="attributes.hse_frac_nbr" default="">
<cfparam name="attributes.hse_dir_cd" default="S">
<cfparam name="attributes.str_nm" default="Los Angeles">
...
<div class="textbox" style="width:730px;padding-left:10px;">
...
<br><br>
The above address was not found in BOE Official Addresses. Applicant need to go to the address counter at any of the Engineering Districts with proof that this is a valid address and the counter will add this address to BOE's database. 
...
<cfquery name="getOtherAddresses" datasource="navla_spatial">
select HSE_ID, PIN, PIND, HSE_NBR, HSE_FRAC_NBR, HSE_DIR_CD, STR_NM, STR_SFX_CD, STR_SFX_DIR_CD, UNIT_RANGE, ZIP_CD, 
X_COORD_NBR, Y_COORD_NBR, ASGN_STTS_IND, ENG_DIST, CNCL_DIST, LON, LAT
from LA_HSE_NBR
...
<span class="data">#HSE_NBR# #HSE_FRAC_NBR# #HSE_DIR_CD# #STR_NM# #STR_SFX_CD# #STR_SFX_DIR_CD# #ZIP_CD# #UNIT_RANGE#</span><br>
</cfoutput>
</p>
</CFIF>
...
<table border="1"  class = "datatable" style = "width:95%;">
<tr>
<th>APN</th>
<th>Owner</th>
...
SELECT  [OBJECTID]
  ...
  where pind = '141A207-201'<!--- '#getAddress.pind#' --->
  </cfquery>
