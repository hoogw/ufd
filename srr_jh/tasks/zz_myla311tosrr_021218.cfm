...
<!--- <cfdump var = "#queryJSON#"><cfdump var = "#lastUpdatedTimestamp#"><cfabort showerror="yep"> --->
  ...
  <cfhttp url = "#queryMethodAPI#" method = "post" timeout = "180" result = "httpMyLA311Resp">
...
<cfmail to="essam.amarragy@lacity.org" from="SRR@lacity.org" subject="311 to SRR ran successfully at #now()#">
311 to SRR ran successfully at #now()#
</cfmail>
