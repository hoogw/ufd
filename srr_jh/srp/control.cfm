...
<cfset request.navbar="navbar1.cfm">
<Cfset request.content="../common/rpt_downloadAll1.cfm">
</cfcase>

<cfcase value = "DownloadALL2">
<cfset request.navbar="navbar1.cfm">
<!--- <Cfset request.content="../common/rpt_downloadAll3.cfm"> --->
<Cfset request.content="../common/create_csv3.cfm">
</cfcase>
<!--- End --->
...
<cfcase value="confirm_attach_delete">
<cfset request.navbar="navbar1.cfm">
<cfset request.content="confirm_attach_delete.cfm">
</cfcase>


<cfcase value="delete_attachment">
<cfset request.navbar="navbar1.cfm">
<cfset request.content="delete_attachment.cfm">
</cfcase>
...
<cfmodule template="#request.content#" srr_id="#request.srr_id#" user="srp">
