...
<cfquery name="may_be_closed" datasource="#request.dsn#" dbtype="datasource">
SELECT 
dbo.srr_info.srr_id
,srr_info.srrKey
...
and 
(
dbo.srr_info.srr_status_cd = 'notEligible'
or 
dbo.srr_info.srr_status_cd = 'ADACompliant'
or 
...
or 
dbo.srr_info.srr_status_cd = 'appealDenied'
or 
dbo.srr_info.srr_status_cd = 'constDurationExp'
or 
dbo.srr_info.srr_status_cd = 'paymentPending'
)
...
<!-- No record are found -->
<cfif #may_be_closed.recordcount# is 0>
<cfoutput>
...
<cfoutput>
<div class="subtitle">#may_be_closed.recordcount# Applications To Cancel/Close</div>
</cfoutput>
...
<cfset request.nbr_of_pages = #may_be_closed.recordcount# / #request.max_rows#>
...
<cfif #end_row# gt #may_be_closed.recordcount#>
<cfset end_row = #may_be_closed.recordcount#>
</cfif>
...
<a href="#cgi.script_name#?action=may_be_closed&page_nbr=#request.prev_page#&#request.addtoken#">&lt;&lt; Previous</A> &nbsp;&nbsp; 
</cfif>
Page:&nbsp;&nbsp;<CFLOOP INDEX="pp" FROM="1" TO="#request.nbr_of_pages#" STEP="1"><cfif #request.page_nbr# is not #pp#><a href="#cgi.script_name#?action=may_be_closed&page_nbr=#pp#&#request.addtoken#"></cfif>#pp#<cfif #request.page_nbr# is not #pp#></A></cfif>&nbsp;&nbsp;&nbsp;</cfloop>
<cfif #request.next_page# lte #request.nbr_of_pages#>
&nbsp;&nbsp; <a href="#cgi.script_name#?action=may_be_closed&page_nbr=#request.next_page#&#request.addtoken#">Next &gt;&gt;</A>
</cfif>
</td>
</tr>
</table>
...
<!--- Record Counter --->
<cfif #may_be_closed.recordcount# is  not 0>
<cfset end_row=#start_row# + #request.max_rows# -1>
<cfif #may_be_closed.recordcount# lt #end_row#>
<cfset end_row=#may_be_closed.recordcount#>
</cfif>
<cfoutput>
<div style="margin-right:auto;margin-left:auto;width:90%;"><div style="width:100%;text-align:right;">Records #start_row# To #END_ROW# out of #may_be_closed.recordcount# Records</div></div>
</cfoutput>
</cfif>
...
<cfoutput query="may_be_closed" startrow="#start_row#" maxrows="#request.max_rows#">


<td style="text-align:center;white-space: nowrap;" nowrap>
<a href="control.cfm?action=close_app1&type=i&srrKey=#may_be_closed.srrKey#&#request.addtoken#">#may_be_closed.sr_number#</a>
</td>

<td style="text-align:center;">
#dateformat(may_be_closed.ddate_submitted,"mm/dd/yyyy")#
</td>

<!--- <td style="text-align:center;">
<p>#dateformat(may_be_closed.received_dt,"mm/dd/yyyy")#</p>
<p>Referred by: #received_from#</p>

<cfif #may_be_closed.staff_user_id# is not "">
<cfquery name="getStaffName" datasource="#request.dsn#" dbtype="datasource">
select first_name, last_name from staff 
where user_id = #may_be_closed.staff_user_id#
</cfquery>
...
<td style="text-align:center;">
#may_be_closed.app_name_nn#
</td>

<td style="text-align:center;">
<strong>#may_be_closed.job_address#</strong>
<cfif #may_be_closed.address_verified# is "N">
