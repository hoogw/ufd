<cfabort>
<!--- This document is used only as needed to create a child ticket on BSS/UFD side for tree inspection --->
...
<cfparam name="attributes.srNum" default="1-382464731">	

<!--- <cfif isdefined("request.srNum")>
<cfset attributes.srNum = #request.srNum#>
</cfif> --->


		
<!--- <cfoutput>
PARENT SR: #attributes.srNum#<br><br>
</cfoutput>
 --->

	<!--- The passed SR Number (myLA311) --->
...
<!--- Setup script variables --->
<cfset upsertMethodAPI = "#request.myLA311Root#/myla311_qa/UpsertSR?apikey=8lN5QbdIeZGNu1P7orjIIemsDwrA7WAR">
<cfif request.production is "p"><cfset upsertMethodAPI = "#request.myLA311Root#/myla311router/mylasrbe/1/UpsertSR"></cfif>
