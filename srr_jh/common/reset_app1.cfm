...
<p><strong>Temporary Notes about required data and more information:</strong></p>
...
<p>How should we capture the information and facilitate copying the information to an A-permit with further data entry on the A-permit side.</p>
</cfoutput>
