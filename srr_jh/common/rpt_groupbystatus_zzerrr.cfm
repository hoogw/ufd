...
<div  class="warning" style="text-align:right;width:200px;margin-right:320px;margin-left:700px;">Council District&nbsp;&nbsp;&nbsp;<select name="council_dist" id="council_dist"onchange="this.form.submit()">
...
<a href="rpt_groupbyQueue.cfm?request.srr_status_cd=#srr_status_cd#">#find_srr.srr_status_desc#
</a></td> 
