...
SELECT        dbo.srr_status.srr_status_cd, dbo.srr_status.srr_status_desc, ISNULL(COUNT(dbo.srr_info.srr_id), 0) AS Num
FROM            dbo.srr_status LEFT OUTER JOIN
                         dbo.srr_info ON dbo.srr_status.srr_status_cd = dbo.srr_info.srr_status_cd
<!--- 						 
		WHERE        (dbo.srr_status.srr_status_desc IN ('Appealed - not Eligible', 'Received - Pending Eligibility Review', 'Appealed - ADA Compliant', 'Appealed - not Eligible', 'Appealed - Offer Expired', 
                         'Incomplete Documents (14 days passed)', 'Incomplete Documents (14 days to provide documents)', 'Not Eligible', 'Not Eligible (can be appealed)', 'Offer Accepted by Applicant', 'Offer Declined by Applicant', 
                         'Offer Declined by Applicant (14 days to change decision)'))	 --->			 
WHERE        (dbo.srr_status.srr_status_desc IN ('Appealed - not Eligible', 'Received - Pending Eligibility Review', 'Already ADA Compliant', 'Appealed - not Eligible', 'Appealed - Offer Expired', 
                         'Incomplete Documents (14 days passed)', 'Incomplete Documents (14 days to provide documents)', 'Not Eligible', 'Not Eligible (can be appealed)', 'Offer Accepted by Applicant', 'Offer Declined by Applicant', 
                         'Offer Declined by Applicant (14 days to change decision)', 'Offer Emailed to Applicant', 'Offer Expired', 'Pending BCA Review', 'Pending BOE Review', 'Pending BSS Review', 'Required Permits Submitted','All Required Permits Issued',
'Appealed - Required Permits not Submitted', 'Construction Completed and Accepted','Required Permits not Submitted on time.'
))						 
GROUP BY dbo.srr_status.srr_status_cd, dbo.srr_status.srr_status_desc
...
WHERE        (dbo.srr_status.srr_status_desc IN ('Appealed - not Eligible', 'Received - Pending Eligibility Review', 'Already ADA Compliant', 'Appealed - not Eligible', 'Appealed - Offer Expired', 
                         'Incomplete Documents (14 days passed)', 'Incomplete Documents (14 days to provide documents)', 'Not Eligible', 'Not Eligible (can be appealed)', 'Offer Accepted by Applicant', 'Offer Declined by Applicant', 
                         'Offer Declined by Applicant (14 days to change decision)', 'Offer Emailed to Applicant', 'Offer Expired', 'Pending BCA Review', 'Pending BOE Review', 'Pending BSS Review', 'Required Permits Submitted', 
                         'All Required Permits Issued','Appealed - Required Permits not Submitted', 'Construction Completed and Accepted','Required Permits not Submitted on time.'))
</CFQUERY> 
...
<a href="rpt_groupbyQueue.cfm?request.srr_status_cd=#srr_status_cd#">
#srr_status_desc#</a></td>
