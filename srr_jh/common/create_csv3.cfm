...
SELECT srr_info.srr_id
	...
	,left(srr_info.sr_app_comments,30000)as sr_app_comments
	,left(srr_info.sr_location_comments,30000)as sr_location_comments
	,left(srr_info.sr_attachments,30000)as sr_attachments
	...
	,left(srr_info.record_history,30000)as record_history
	...
	,left(srr_info.bpw1_ownership_comments,30000) as bpw1_ownership_comments
	,srr_info.bpw1_tax_verified
	,left(srr_info.bpw1_tax_comments,30000)as bpw1_tax_comments
	,left(srr_info.bpw1_comments_to_app,30000)as bpw1_comments_to_app
	,left(srr_info.bpw1_internal_comments,30000)as bpw1_internal_comments
	,srr_info.bpw2_action_by
	,left(srr_info.bpw2_internal_comments,30000)as bpw2_internal_comments
	,srr_info.bpw2_action_dt
	,left(srr_info.bca_comments,30000)as bca_comments
	,left(srr_info.bss_comments,30000)as bss_comments
	,left(srr_info.gis_comments,30000)as gis_comments
	,left(srr_info.paymentIncompleteReasons,30000)as paymentIncompleteReasons
	...
	,left(srr_info.boe_invest_comments,30000)as boe_invest_comments
	,left(srr_info.boe_invest_response_to_app,30000)as boe_invest_response_to_app
	...
	,left(srr_info.justification,30000)as justification
	,srr_info.ext_grantedDays
	,srr_info.ext_granted_dt
	,srr_info.ext_granted_by
	,left(srr_info.close_cancel_comments,30000)as close_cancel_comments
...
output="#chr(34)##jsonSafe(tsrr_id)##chr(34)#,
#chr(34)##jsonSafe(tsr_number)##chr(34)#,
#chr(34)##jsonSafe(ttree_insp_sr_number)##chr(34)#,
#chr(34)##jsonSafe(tsr_app_comments)##chr(34)#,
#chr(34)##jsonSafe(tsr_location_comments)##chr(34)#,
#chr(34)##jsonSafe(tsr_attachments)##chr(34)#,
#chr(34)##jsonSafe(tsrr_status_desc)##chr(34)#,
#chr(34)##jsonSafe(tapp_name_nn)##chr(34)#,
#chr(34)##jsonSafe(tapp_email_nn)##chr(34)#,
#chr(34)##jsonSafe(tprop_owned_by_desc)##chr(34)#,
#chr(34)##jsonSafe(ta_ref_no)##chr(34)#,
#chr(34)##jsonSafe(tapp_id)##chr(34)#,
#chr(34)##jsonSafe(tddate_submitted)##chr(34)#,
#chr(34)##jsonSafe(twaitListed_to_received_dt)##chr(34)#,
#chr(34)##jsonSafe(trate_nbr)##chr(34)#,
#chr(34)##jsonSafe(tzip_cd)##chr(34)#,
#chr(34)##jsonSafe(ttbm_grid)##chr(34)#,
#chr(34)##jsonSafe(tboe_dist)##chr(34)#,
#chr(34)##jsonSafe(tcouncil_dist)##chr(34)#,
#chr(34)##jsonSafe(tbpp)##chr(34)#,
#chr(34)##jsonSafe(tpind)##chr(34)#,
#chr(34)##jsonSafe(taddress_verified)##chr(34)#,
#chr(34)##jsonSafe(tzoningCode)##chr(34)#,
#chr(34)##jsonSafe(tprop_type)##chr(34)#,
#chr(34)##jsonSafe(tprop_data_checked)##chr(34)#,
#chr(34)##jsonSafe(tjob_address)##chr(34)#,
#chr(34)##jsonSafe(tapp_contact_name_nn)##chr(34)#,
#chr(34)##jsonSafe(tapp_address1_nn)##chr(34)#,
#chr(34)##jsonSafe(tapp_address2_nn)##chr(34)#,
#chr(34)##jsonSafe(tapp_city_nn)##chr(34)#,
#chr(34)##jsonSafe(tapp_state_nn)##chr(34)#,
#chr(34)##jsonSafe(tapp_zip_nn)##chr(34)#,
#chr(34)##jsonSafe(tapp_phone_nn)##chr(34)#,
#chr(34)##jsonSafe(tmailing_address1)##chr(34)#,
#chr(34)##jsonSafe(tmailing_address2)##chr(34)#,
#chr(34)##jsonSafe(tmailing_zip)##chr(34)#,
#chr(34)##jsonSafe(tmailing_city)##chr(34)#,
#chr(34)##jsonSafe(tmailing_state)##chr(34)#,
#chr(34)##jsonSafe(tmailing_address_comp_dt)##chr(34)#,
#chr(34)##jsonSafe(tbpw1_action_by)##chr(34)#,
#chr(34)##jsonSafe(tbpw1_action_dt)##chr(34)#,
#chr(34)##jsonSafe(tbca_action_by)##chr(34)#,
#chr(34)##jsonSafe(tbca_assessment_comp_dt)##chr(34)#,
#chr(34)##jsonSafe(tbca_to_bss_dt)##chr(34)#,
#chr(34)##jsonSafe(tbca_to_boe_dt)##chr(34)#,
#chr(34)##jsonSafe(tAdaCompliant_dt)##chr(34)#,
#chr(34)##jsonSafe(tAdaCompliant_exp_dt)##chr(34)#,
#chr(34)##jsonSafe(tbss_action_by)##chr(34)#,
#chr(34)##jsonSafe(tbss_to_boe_dt)##chr(34)#,
#chr(34)##jsonSafe(tbss_assessment_comp_dt)##chr(34)#,
#chr(34)##jsonSafe(tsrp_action_dt)##chr(34)#,
#chr(34)##jsonSafe(tbpw_to_bca_dt)##chr(34)#,
#chr(34)##jsonSafe(tbpw_to_boe_dt)##chr(34)#,
#chr(34)##jsonSafe(teligibility_dt)##chr(34)#,
#chr(34)##jsonSafe(tincompleteDocs_dt)##chr(34)#,
#chr(34)##jsonSafe(tincompleteDocs_exp_dt)##chr(34)#,
#chr(34)##jsonSafe(trecord_history)##chr(34)#,
#chr(34)##jsonSafe(tnotEligible_dt)##chr(34)#,
#chr(34)##jsonSafe(tnotEligible_exp_dt)##chr(34)#,
#chr(34)##jsonSafe(toffer_reserved_amt)##chr(34)#,
#chr(34)##jsonSafe(toffer_open_amt)##chr(34)#,
#chr(34)##jsonSafe(toffer_accepted_amt)##chr(34)#,
#chr(34)##jsonSafe(toffer_paid_amt)##chr(34)#,
#chr(34)##jsonSafe(tofferMade_dt)##chr(34)#,
#chr(34)##jsonSafe(tofferMade_exp_dt)##chr(34)#,
#chr(34)##jsonSafe(tofferAccepted_dt)##chr(34)#,
#chr(34)##jsonSafe(tofferAccepted_exp_dt)##chr(34)#,
#chr(34)##jsonSafe(tofferDeclined_dt)##chr(34)#,
#chr(34)##jsonSafe(tofferDeclined_exp_dt)##chr(34)#,
#chr(34)##jsonSafe(tgis_completed_dt)##chr(34)#,
#chr(34)##jsonSafe(tgis_completed_by)##chr(34)#,
#chr(34)##jsonSafe(tbpw1_ownership_verified)##chr(34)#,
#chr(34)##jsonSafe(tbpw1_ownership_comments)##chr(34)#,
#chr(34)##jsonSafe(tbpw1_tax_verified)##chr(34)#,
#chr(34)##jsonSafe(tbpw1_tax_comments)##chr(34)#,
#chr(34)##jsonSafe(tbpw1_comments_to_app)##chr(34)#,
#chr(34)##jsonSafe(tbpw1_internal_comments)##chr(34)#,
#chr(34)##jsonSafe(tbpw2_action_by)##chr(34)#,
#chr(34)##jsonSafe(tbpw2_internal_comments)##chr(34)#,
#chr(34)##jsonSafe(tbpw2_action_dt)##chr(34)#,
#chr(34)##jsonSafe(tbca_comments)##chr(34)#,
#chr(34)##jsonSafe(tbss_comments)##chr(34)#,
#chr(34)##jsonSafe(tgis_comments)##chr(34)#,
#chr(34)##jsonSafe(tpaymentIncompleteReasons)##chr(34)#,
#chr(34)##jsonSafe(tpaymentIncompleteDocs_dt)##chr(34)#,
#chr(34)##jsonSafe(tpaymentIncompleteDocs_exp_dt)##chr(34)#,
#chr(34)##jsonSafe(tpaymentPending_dt)##chr(34)#,
#chr(34)##jsonSafe(tcont_license_no)##chr(34)#,
#chr(34)##jsonSafe(tcont_name)##chr(34)#,
#chr(34)##jsonSafe(tcont_address)##chr(34)#,
#chr(34)##jsonSafe(tcont_city)##chr(34)#,
#chr(34)##jsonSafe(tcont_state)##chr(34)#,
#chr(34)##jsonSafe(tcont_zip)##chr(34)#,
#chr(34)##jsonSafe(tcont_phone)##chr(34)#,
#chr(34)##jsonSafe(tcont_lic_issue_dt)##chr(34)#,
#chr(34)##jsonSafe(tcont_lic_exp_dt)##chr(34)#,
#chr(34)##jsonSafe(tcont_lic_class)##chr(34)#,
#chr(34)##jsonSafe(tcont_info_comp_dt)##chr(34)#,
#chr(34)##jsonSafe(tanyLiens)##chr(34)#,
#chr(34)##jsonSafe(tliensText)##chr(34)#,
#chr(34)##jsonSafe(tclose_bss_sr311)##chr(34)#,
#chr(34)##jsonSafe(tboe_invest_comments)##chr(34)#,
#chr(34)##jsonSafe(tboe_invest_response_to_app)##chr(34)#,
#chr(34)##jsonSafe(tboe_invest_response_dt)##chr(34)#,
#chr(34)##jsonSafe(tboe_invest_response_by)##chr(34)#,
#chr(34)##jsonSafe(tboe_invest_decision)##chr(34)#,
#chr(34)##jsonSafe(tboe_invest_to_bpw_dt)##chr(34)#,
#chr(34)##jsonSafe(tboe_invest_to_bpw_by)##chr(34)#,
#chr(34)##jsonSafe(tboe_invest_to_bca_dt)##chr(34)#,
#chr(34)##jsonSafe(tboe_invest_to_bca_by)##chr(34)#,
#chr(34)##jsonSafe(tboe_invest_to_bss_dt)##chr(34)#,
#chr(34)##jsonSafe(tboe_invest_to_bss_by)##chr(34)#,
#chr(34)##jsonSafe(tboe_invest_notEligible_dt)##chr(34)#,
#chr(34)##jsonSafe(tboe_invest_notEligible_by)##chr(34)#,
#chr(34)##jsonSafe(trequiredPermitsNotSubmitted_dt)##chr(34)#,
#chr(34)##jsonSafe(trequiredPermitsNotSubmitted_exp_dt)##chr(34)#,
#chr(34)##jsonSafe(trequiredPermitsSubmitted_dt)##chr(34)#,
#chr(34)##jsonSafe(trequiredPermitsIssued_dt)##chr(34)#,
#chr(34)##jsonSafe(trequiredPermitsIssued_exp_dt)##chr(34)#,
#chr(34)##jsonSafe(tconstCompleted_dt)##chr(34)#,
#chr(34)##jsonSafe(tApermitIssued_dt)##chr(34)#,
#chr(34)##jsonSafe(tApermitSubmitted_dt)##chr(34)#,
#chr(34)##jsonSafe(tapp_last_update_dt)##chr(34)#,
#chr(34)##jsonSafe(tlgd_completed_dt)##chr(34)#,
#chr(34)##jsonSafe(tlgd_completed_by)##chr(34)#,
#chr(34)##jsonSafe(tjustification)##chr(34)#,
#chr(34)##jsonSafe(text_grantedDays)##chr(34)#,
#chr(34)##jsonSafe(text_granted_dt)##chr(34)#,
#chr(34)##jsonSafe(text_granted_by)##chr(34)#,
#chr(34)##jsonSafe(tclose_cancel_comments)##chr(34)#,
#chr(34)##jsonSafe(tclose_cancel_by)##chr(34)#,
#chr(34)##jsonSafe(tclose_cancel_dt)##chr(34)#,
#chr(34)##jsonSafe(tfiling_folder_created)##chr(34)#,
#chr(34)##jsonSafe(tw9_on_file)##chr(34)#,
#chr(34)##jsonSafe(tvaluation_est)##chr(34)#">
<!--- #request.directory# --->
...
EXCEL FILE "Sidewalk_#dateformat(Now(),"mm_dd_yyyy")#.xls" <br> HAS BEEN CREATED AND IS AVAILABLE FOR DOWNLOADING. 
