...
, tree_pruning_permit.ddate_submitted AS tp_submit_ddate
, tree_pruning_permit.bss_issued_by as tp_issue_by
, tree_pruning_permit.bss_ddate_issued as tp_issue_ddate
...
FROM  dbo.staff RIGHT OUTER JOIN
               dbo.tree_pruning_permit ON dbo.staff.user_id = dbo.tree_pruning_permit.bss_issued_by RIGHT OUTER JOIN
               dbo.srr_info LEFT OUTER JOIN
               dbo.tree_info ON dbo.srr_info.srr_id = dbo.tree_info.srr_id ON dbo.tree_pruning_permit.srr_id = dbo.srr_info.srr_id

where srr_info.srr_id = #request.srr_id#
</cfquery>

<cfdocument  format="PDF" pagetype="letter" margintop=".2" marginbottom=".5" marginright=".3" marginleft=".3" orientation="portrait" unit="in" encryption="none" fontembed="Yes" backgroundvisible="Yes" bookmark="False" localurl="Yes">
<style type="text/css">
* {
...
<TR>
<TD  style="vertical-align:top;text-align:center;"><img src="../images/BSS_logo.jpg" alt="" width="108" height="85" border="0" align="top">
</TD>

<TD  style="vertical-align:top;text-align:center;">
APPLICATION FOR A<BR>
TREE ROOT PRUNING PERMIT<BR>
...
<tr><td style = "padding:15px;"><div align="center"><span class="data" >TREE ROOT PRUNING PERMIT</span></div><br></td></tr>
...
<TR>
<TD nowrap > Total Number of tree(s):&nbsp;&nbsp;<span class="data">#printPermit.nbr_trees_pruned# (#numberformat(printPermit.lf_trees_pruned)# LF)</span> &nbsp;&nbsp;&nbsp;&nbsp;Reason for tree pruning: &nbsp;&nbsp; <span class="data">Repair/Replace Sidewalk</span></td>
...
<table  border="0" >
<TR>
<TD >If the tree pruning is approved and any fees due have been paid, the permit should be made out to:  </td>
</tr>
...
<TR>
<TD colspan="3">I am submitting this application along with attached checklist (as indicated above) and required documents to the above address.  I understand that submittal of this application does not guarantee an approval for a tree pruning permit.  
</td>
...
<td  align="left">
Date Issued:<br>
<span class="data">#DateFormat(printPermit.tp_issue_ddate,"mm/dd/yyyy")#</span>
