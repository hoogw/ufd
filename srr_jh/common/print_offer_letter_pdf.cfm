...
SELECT srr_id, ddate_submitted, app_id, app_name_nn, app_contact_name_nn, app_address1_nn, app_address2_nn, app_city_nn, app_state_nn, app_zip_nn, 
               app_phone_nn, app_email_nn, job_address, job_city, job_state, job_zip, unit_range, mailing_address1, mailing_address2, mailing_zip, mailing_city, 
               mailing_state
...
<div align="center">
<b>Offer for Sidewalk Repair Rebate Program</b>
</div>


<p>This letter is to inform you that the City of Los Angeles has completed reviewing your application under the Sidewalk Repair Rebate Program and is offering you the following</p>

<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.</p>


<ul>
<p><strong>Other Conditions:</strong><br>
<li>Work has to be completed by a licensed contractor with x number of days.</li><br>
<li>Work has to be inspected and accepted by the Bureau of Contract Administration/Board of Public Works.</li><br></p>
</ul>
