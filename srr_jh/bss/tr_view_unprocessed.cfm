...
, DateDiff("d", Tree_removal_permit.ddate_submitted, getDate()) as daysInQueue
, srr_info.ddate_submitted as sr_submitted_dt
...
WHERE
Tree_removal_permit.bss_ddate_issued is null and tree_removal_permit.ddate_submitted is not null
</cfquery>
...
<th nowrap>Ticket Submitted on</th>
<th nowrap>Permit Submitted on</th>
...
<td style="text-align:center;">
<a href="control.cfm?action=process_tr_app1&srrKey=#tr_view_unprocessed.srrKey#&#request.addtoken#">#tr_view_unprocessed.sr_number#</a>
</td>

<td style="text-align:center;">
#dateformat(tr_view_unprocessed.sr_submitted_dt,"mm/dd/yyyy")#
</td>
...
<td style="text-align:center;">
<strong>#ucase(tr_view_unprocessed.job_address)#</strong>
</td>
