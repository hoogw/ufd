...
<cfoutput>
<form action="control.cfm?action=uploadfile2&srrKey=#request.srrKey#&#request.addtoken#" method="post" enctype="MULTIPART/FORM-DATA" name="form1" id="form1" onSubmit="return checkForm();">

<div class="formbox" style="width:550px;">
<h1>SRR ID: #request.srr_id# - Add Attachment</h1>
