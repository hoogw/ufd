...
<cflocation url="../admin.htm" addtoken="No">
</cfif>
...
select * from staff
where user_name = '#trim(request.user_name)#' and administrator = 1
</cfquery>

<cfif #checkit.recordcount# is "0">
<cfmodule template="/common/error_msg.cfm" error_msg="Your are not authorized to Access this page!<br><br>Please Contact Administrator." showBackButton="1">
<cfabort>
</cfif>
...
<cfset client.admin_login=1>
<cfset client.administrator = 1>

<cfif #request.user_password# is "eng78" or #request.user_password# is "newuser">
<cflocation url="control.cfm?action=edit_password1&login=1&#request.addtoken#"> 
</cfif>
