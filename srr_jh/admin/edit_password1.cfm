...
<form action="control.cfm?action=edit_password2&#request.addtoken#" method="post" name="form1" id="form1" onSubmit="return checkForm();">
<input type="hidden" name="login" id="login" value="#request.login#">
...
<TD>
<input type="password" name="pw1" id="pw1" size="12">
</TD>
</tr>
