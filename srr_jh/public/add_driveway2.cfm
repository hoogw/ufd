...
<cfparam name="request.driveway_category" default="">
<cfparam name="request.driveway_material" default="">
...
update srr_info
set
record_history = record_history + '|A driveway was added by applicant on #dateformat(Now(),"mm/dd/yyyy")# at #timeformat(now(),"h:mm tt")#.'
