...
<cfif #checkStatus.srr_status_cd# is "cancelTicket">
...
<cfif #checkStatus.srr_status_cd# is "closeTicket">
<div class="warning">Your Application is Closed</div>
<cfabort>
</cfif>
...
<div class="warning">
The appeal window has expired on #dateformat(request.appeal_exp_dt,"mm/dd/yyyy")#.
You may 
</div>	
...
<cfparam name="request.appealDesc" default="">
<cfparam name="request.appealReason" default="">
