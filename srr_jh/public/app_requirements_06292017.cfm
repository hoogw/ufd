...
or #getSRR.srr_status_cd# is "incompleteDocsExp"
or #getSRR.srr_status_cd# is "paymentIncompleteDocsExp"
>
<div class="warning">
...
<Cfif<!---  isdate(#getSRR.cont_info_comp_dt#) and  ---> isdate(#checkApermit.ddate_submitted#) and NOT isdate(#checkApermit.boe_ddate_processed#)>
