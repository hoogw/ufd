...
insert into tree_removal_permit
(
srr_id
, ddate_submitted
)
...
record_history = record_history + '|A Tree Removal Permit was submitted by applicant on #dateformat(Now(),"mm/dd/yyyy")# at #timeformat(now(),"h:mm tt")#.'
...
<cfoutput>
<div class="warning">
Your Tree Removal Permit was Successfully Submitted
</div>

<div align="center"><input type="button" name="submit" id="submit" value="Back to Requirements" class="submit" onClick="location.href = 'app_requirements.cfm?srrKey=#request.srrKey#&#request.addtoken#'"></div>
</cfoutput>