...
<!--- <div class="formbox"> --->
<div class="divSubTitle">Add Sidewalk Segment</div>

<div class="field">
<label>Segment Length</label>
<input type="number" name="sw_length_ft" id="sw_length_ft" size="10" placeholder="ft" required="Yes">&nbsp;&nbsp;&nbsp;<input type="number" name="sw_length_in" id="sw_length_in" size="10" placeholder="in">
</div>

<div class="field">
<label>Segment Width</label>
<input type="number" name="sw_width_ft" id="sw_width_ft" size="10" placeholder="ft" required="Yes">&nbsp;&nbsp;&nbsp;<input type="number" name="sw_width_in" id="sw_width_in" size="10" placeholder="in">
</div>
