...
<cfmodule template="../modules/dsp_srTicketInfo_module.cfm" srrKey = "#request.srrKey#" width="95%">



<cfmodule template="../modules/addressReportModule.cfm" hse_nbr="#propReport.hse_nbr#" hse_frac_nbr="#propReport.hse_frac_nbr#" hse_dir_cd="#propReport.hse_dir_cd#" str_nm="#propReport.str_nm#" str_sfx_cd="#propReport.str_sfx_cd#" zip_cd="#propReport.zip_cd#">
