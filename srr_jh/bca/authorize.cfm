...
<cflocation url="../bca.htm" addtoken="No">
</cfif>
...
select * from staff
where user_name = '#trim(request.user_name)#' and (user_agency = 'bca' or user_agency = 'all')
</cfquery>
...
<cflocation url="view_unprocessed.cfm?#request.addtoken#" addtoken="No"> 
</cfif>