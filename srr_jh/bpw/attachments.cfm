...
<cfif #right(request.file_name,4)# is  ".pdf">
<a href="/docs/srr/uploads/#request.srr_id#/#request.file_name#" target="_blank">#request.file_name#</a>
<cfelse>
<a href="../common/display_attachment.cfm?file_name=#request.file_name#&srrKey=#request.srrKey#&#request.addtoken#" target="_blank">#request.file_name#</a>
</cfif>
</td>
