...
<p><strong><em>Unprocessed Investigations:</em></strong> This menu item provides a list of all Sidewalk Rebate Request (SRR) Program applications forwarded to the Board of Public Works for eligibility review. An application may be selected for review and processing by clicking on the SR number.</p>


<p><strong><em>Ready to Pay:</em></strong> This menu item provides a list of SRR applications that have completed construction and may be ready to receive a rebate check. Board Staff will review the application to verify that a W-9 has been submitted. Review the checklist necessary for the Office of Accounting and forward the request manually for the City to issue a Rebate Check to the property owner-applicant.
</p>
